(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-1qgyj6k"><!><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-1qgyj6k" href="#top"><!></a></div>`), Tooltip[FILENAME], [[380, 4, [[389, 8], [392, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-1qgyj6k" role="button" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[306, 5]]);
	var root_3 = add_locations(from_html(`<span class="qc-hash-1qgyj6k">&zwj;</span>`), Tooltip[FILENAME], [[312, 8]]);
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 390, 31);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 402, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
...

		{
			var consequent = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_5, textSlot), 'render', Tooltip, 310, 21);
				reset(span);
				append($$anchor, span);
			};
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 362, 9);
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_11, () => "modal"), 'render', Tooltip, 370, 16);
						reset(div_5);
						reset(dialog);
