(function () {
	...
	function add_css$1(target) {
		append_styles(target, "qc-hash-1wi04uc", "@charset \"UTF-8\";a.qc-hash-1wi04uc{color:var(--qc-color-link-text)}a.qc-hash-1wi04uc:visited{color:var(--qc-color-link-visited)}a.qc-hash-1wi04uc:hover{color:var(--qc-color-link-hover);text-decoration:none}a.qc-hash-1wi04uc:focus{color:var(--qc-color-link-hover);text-decoration:none;outline:2px solid var(--qc-color-link-focus-outline)}a.qc-hash-1wi04uc:active{color:var(--qc-color-link-active);text-decoration:none}:host{display:flex;flex-direction:column;align-items:center;margin-top:4rem;padding-bottom:3.2rem;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}a.qc-hash-1wi04uc{text-decoration:none}a.qc-hash-1wi04uc:hover{text-decoration:underline}.copyright.qc-hash-1wi04uc{margin-top:3.2rem}@media(prefers-color-scheme: dark){svg.qc-hash-1wi04uc{fill:var(--qc-color-text-primary)}}");
	}
	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				...
				attr(svg, "class", "qc-hash-1wi04uc");
				attr(a, "href", /*logoUrl*/ ctx[0]);
				attr(a, "class", "qc-hash-1wi04uc");
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, svg);
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-1wi04uc");
			},
			m(target, anchor) {
				if (default_slot) {
