(function () {
	...
	var root$7 = add_locations(from_html(`<!> <link rel="stylesheet"/>`, 1), TextFieldWC[FILENAME], [[115, 0]]);
	...
	var root_2 = add_locations(from_html(`<h1 class="qc-tooltip-title qc-hash-1ejnoxp"> </h1>`), Tooltip[FILENAME], [[434, 23]]);
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-1ejnoxp"><div class="qc-tooltip-content-text qc-hash-1ejnoxp"><!> <!><!></div></div> <a role="button" class="qc-tooltip-xclose qc-hash-1ejnoxp" href="#top"><!></a></div>`), Tooltip[FILENAME], [[422, 4, [[432, 8, [[433, 12]]], [438, 8]]]]);
	var root_3 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-1ejnoxp" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[338, 5]]);
	var root_4 = add_locations(from_html(`<span class="qc-hash-1ejnoxp">&zwj;</span>`), Tooltip[FILENAME], [[343, 8]]);
	...
	var root_6 = add_locations(
		...
		Tooltip[FILENAME],
		[[374, 9, [[378, 13, [[384, 16], [392, 16], [395, 16]]]]]]
	);

	var root_7 = add_locations(from_html(`<dialog><div class="qc-container qc-hash-1ejnoxp"><!></div></dialog>`), Tooltip[FILENAME], [[403, 9, [[411, 12]]]]);
	var root_5 = add_locations(from_html(`<div><div class="clickable-gutter qc-hash-1ejnoxp"></div> <a role="button" class="qc-tooltip-button qc-hash-1ejnoxp" href="#top"><!></a> <!> <!></div>`), Tooltip[FILENAME], [[347, 5, [[354, 9], [357, 9]]]]);
	var root$1 = add_locations(from_html(`<div class="qc-tooltip qc-hash-1ejnoxp"><!> <!></div>`), Tooltip[FILENAME], [[324, 0]]);

	const $$css = {
		hash: 'qc-hash-1ejnoxp',
		code: '\n    .qc-tooltip.qc-hash-1ejnoxp {\n        display: inline-flex;\n        align-items: center;\n        font-size: var(--qc-font-size-md);\n        font-family: var(--qc-font-family-content);\n        font-weight: var(--qc-font-weight-regular);\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .clickable-gutter.qc-hash-1ejnoxp {\n        position: absolute;\n        height: 24px;\n        width: 24px;\n        left: -4px;\n        top: -4px;\n        cursor: pointer;\n    }\n    .qc-tooltip-text.qc-hash-1ejnoxp {\n        border-bottom: 1px dashed var(--qc-color-blue-piv);\n        cursor: pointer;\n        white-space: nowrap;\n        margin-right: calc( .5 * var(--qc-spacer-xs) );\n    }\n    .qc-tooltip-button.qc-hash-1ejnoxp {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-1ejnoxp {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-1ejnoxp {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-1ejnoxp {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-1ejnoxp {\n        overflow-y: auto;\n        max-height: calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right: 16px;\n        padding-top: 3px;\n        padding-left: 3px;\n    }\n\n    .qc-tooltip-content-text.qc-hash-1ejnoxp {\n        max-inline-size: var(--qc-max-content-width);\n    }\n\n    h1.qc-hash-1ejnoxp /* (unused) h2,h3,h4,h5,h6,[role="heading"]*/ {\n        font-size: var(--qc-font-size-sm);\n        font-weight: var(--qc-font-weight-bold);\n        line-height: var(--qc-line-height-sm);\n        margin: 0;\n        font-family: var(--qc-font-family-content);\n        &::after{\n            display: none;\n        }\n    }\n\n\n    .qc-tooltip-content.qc-hash-1ejnoxp:focus-visible {\n        outline: none;\n    }\n\n    .qc-tooltip-xclose.qc-hash-1ejnoxp {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n    dialog.qc-hash-1ejnoxp {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n\n        &.qc-desktop {\n            padding-top: 8px;\n        }\n\n        .qc-tooltip-panel:where(.qc-hash-1ejnoxp) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-1ejnoxp) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-1ejnoxp {\n        font-size: var(--qc-font-size-sm);\n        line-height: var(--qc-line-height-sm);\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        padding-top: 21px;\n        padding-left: 13px;\n        padding-bottom: 24px;\n    }\n\n    .qc-tooltip-popover.qc-hash-1ejnoxp {\n\n        .qc-tooltip-panel:where(.qc-hash-1ejnoxp) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding-right: 8px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-1ejnoxp) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-1ejnoxp),\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-1ejnoxp)\n        {\n            left: calc(.5 * var(--pin-height) - 1px);\n        }\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-1ejnoxp) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-1ejnoxp) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-1ejnoxp) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-1ejnoxp) {\n            visibility: visible;\n        }\n\n        .qc-tooltip-content:where(.qc-hash-1ejnoxp):focus-visible {\n            outline: 2px solid var(--qc-color-blue-regular);\n            outline-offset: 1px;\n        }\n    }\n\n    .qc-hash-1ejnoxp::-webkit-scrollbar,\n    .qc-hash-1ejnoxp::-webkit-scrollbar-track,\n    .qc-hash-1ejnoxp::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-1ejnoxp::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_2, descriptionSlot), 'render', Tooltip, 435, 31);
			reset(div_2);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_3, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 453, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
		...
		div_3.__focusout = markInnerEvent;
...

		{
			var consequent_1 = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_6, textSlot), 'render', Tooltip, 341, 21);
				reset(span);
				append($$anchor, span);
			};
			...
			add_svelte_meta(
				() => if_block(node_4, ($$render) => {
					if (get(hasText)) $$render(consequent_1); else $$render(alternate, false);
				}),
				'if',
				Tooltip,
				337,
			...
			var consequent_4 = ($$anchor) => {
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_10, () => "popover"), 'render', Tooltip, 400, 9);
						template_effect(() => classes_2 = set_class(div_6, 1, 'qc-tooltip-pin qc-hash-1ejnoxp', null, classes_2, { 'qc-tooltip-visible': get(visiblePopover) }));
						append($$anchor, fragment);
					};
...

				{
					var consequent_3 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_12, () => "modal"), 'render', Tooltip, 412, 16);
						reset(div_7);
						reset(dialog);
				...
				template_effect(() => {
					classes_1 = set_class(div_4, 1, `qc-tooltip-container qc-tooltip-${get(position) ?? ''} qc-scrollbar`, 'qc-hash-1ejnoxp', classes_1, {
						'qc-tooltip-popover': !get(modalFlag),
						'qc-tooltip-modal': get(modalFlag)
					});

					styles_1 = set_style(div_4, '', styles_1, { '--max-height': `${get(modalFlag) ? "320px" : "160px"};` });
					set_attribute(a_1, 'aria-label', labels.tooltipButton.ariaLabel);
					set_attribute(a_1, 'aria-describedby', tooltipId);
				});
		...
		reset(div_3);
		bind_this(div_3, ($$value) => tooltipContainer = $$value, () => tooltipContainer);
		append($$anchor, div_3);
