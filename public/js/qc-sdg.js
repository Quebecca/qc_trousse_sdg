(function () {
	...
	function add_css(target) {
		append_styles(target, "qc-hash-1o6o3cf", "span.qc-hash-1o6o3cf,a.qc-hash-1o6o3cf{display:inline-block;margin-right:4px}.selected.qc-hash-1o6o3cf{font-weight:bold}");
	}
	...
	// (41:4) {#each $noteStore[id].links ?? [] as letter}
	...
	function create_fragment$1(ctx) {
		...
		return {
			c() {
				...
				attr(span, "class", "qc-hash-1o6o3cf");
			},
			m(target, anchor) {
				insert(target, span, anchor);
				append(span, t0);
			...
			p(ctx, [dirty]) {
				if (dirty & /*index*/ 2) set_data(t0, /*index*/ ctx[1]);
				...
				if (dirty & /*id*/ 1 && span_id_value !== (span_id_value = "qc-note-" + /*id*/ ctx[0])) {
	...
	class Note extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$2, create_fragment$1, safe_not_equal, { self: 4, id: 0, index: 1 }, add_css);
		}
	...
	function create_if_block(ctx) {
		let a;
		let t0_value = /*$noteStore*/ ctx[2][/*targetId*/ ctx[0]].index + "";
		let t0;
		let t1;
		let a_href_value;
		let a_id_value;
		...
		return {
			c() {
				a = element("a");
				t0 = text(t0_value);
				t1 = text(/*letter*/ ctx[1]);
				attr(a, "href", a_href_value = "#qc-note-" + /*targetId*/ ctx[0]);
				attr(a, "id", a_id_value = "qc-note-link-" + /*targetId*/ ctx[0] + "-" + /*letter*/ ctx[1]);
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, t0);
			...
			p(ctx, dirty) {
				if (dirty & /*$noteStore, targetId*/ 5 && t0_value !== (t0_value = /*$noteStore*/ ctx[2][/*targetId*/ ctx[0]].index + "")) set_data(t0, t0_value);
				if (dirty & /*letter*/ 2) set_data(t1, /*letter*/ ctx[1]);

				if (dirty & /*targetId*/ 1 && a_href_value !== (a_href_value = "#qc-note-" + /*targetId*/ ctx[0])) {
					attr(a, "href", a_href_value);
				}

				if (dirty & /*targetId, letter*/ 3 && a_id_value !== (a_id_value = "qc-note-link-" + /*targetId*/ ctx[0] + "-" + /*letter*/ ctx[1])) {
	...
	function create_fragment(ctx) {
		let if_block_anchor;
		let if_block = /*$noteStore*/ ctx[2][/*targetId*/ ctx[0]] && create_if_block(ctx);
		...
		return {
			...
			p(ctx, [dirty]) {
				if (/*$noteStore*/ ctx[2][/*targetId*/ ctx[0]]) {
					if (if_block) {
						if_block.p(ctx, dirty);
					} else {
	...
	function instance$1($$self, $$props, $$invalidate) {
		let $noteStore;
		component_subscribe($$self, noteStore, $$value => $$invalidate(2, $noteStore = $$value));
		let { targetId } = $$props;
		let letter;
		...
		$$self.$$.update = () => {
			if ($$self.$$.dirty & /*letter, $noteStore, targetId*/ 7) {
				if (!letter && $noteStore[targetId]) {
					$$invalidate(1, letter = indexToLetter($noteStore[targetId].links.length + 1));
					set_store_value(noteStore, $noteStore[targetId].links = [...$noteStore[targetId].links, letter], $noteStore);
				}
			}
		};

		return [targetId, letter, $noteStore, click_handler];
	}

	class NoteLink extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$1, create_fragment, safe_not_equal, { targetId: 0 });
		}
	...
	customElements.define("qc-note-link", create_custom_element(NoteLink, {"targetId":{"attribute":"target-id","type":"String"}}, [], [], false));
