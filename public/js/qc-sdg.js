(function () {
	...
	function add_css(target) {
		append_styles(target, "qc-hash-2ghgym", "@charset \"UTF-8\";img.qc-hash-2ghgym{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}");
	}
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(img_1, "class", "qc-hash-2ghgym");
			},
			m(target, anchor) {
