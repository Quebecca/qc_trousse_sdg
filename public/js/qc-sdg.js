(function () {
	...
	var root_1 = add_locations(from_html(`<div><div class="qc-tooltip-content qc-hash-z995yd"><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-z995yd" href="#top"><!></a></div>`), Tooltip[FILENAME], [[290, 4, [[297, 8], [300, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-z995yd" role="button" tabindex="-1"><!></span>`), Tooltip[FILENAME], [[229, 5]]);

	var root_4 = add_locations(
		from_html(
			`<div><svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="qc-hash-z995yd"><style class="qc-hash-z995yd">.triangle {
                        fill: var(--qc-color-background);
                    }
                    .stroke {
                        fill: var(--qc-color-grey-light);
                    }</style><path class="triangle qc-hash-z995yd" d="M8.02002 14.1667L1.35335 7.50004L8.02002 0.833374L8.02002 14.1667Z"></path><path class="stroke qc-hash-z995yd" d="M1.35335 7.5L8.02002 14.1667L8.02002 15H7.02002V14.5118L1.90735e-05 7.5L7.02002 0.488157V0L8.02002 3.64262e-08L8.02002 0.833335L1.35335 7.5Z"></path></svg></div> <!>`,
			1
		),
		Tooltip[FILENAME],
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function ($$anchor) {
			...
			template_effect(() => {
				classes = set_class(div, 1, 'qc-tooltip-panel qc-hash-z995yd', null, classes, {
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						template_effect(() => classes_2 = set_class(div_3, 1, 'qc-tooltip-pin qc-hash-z995yd', null, classes_2, { 'qc-tooltip-visible': get(visible) }));
						append($$anchor, fragment);
					};
				...
				template_effect(() => {
					classes_1 = set_class(div_2, 1, `qc-tooltip-container qc-tooltip-${get(position) ?? ''} qc-scrollbar`, 'qc-hash-z995yd', classes_1, {
