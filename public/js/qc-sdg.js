(function () {
	...
	var root$1 = from_html(`<div class="root qc-hash-ydav1d"><label>Test.svelte</label> <!> <div>--</div> <!></div>`);
	...
	function Test($$anchor, $$props) {
		...
		let foo = prop($$props, 'foo'),
			slot1 = prop($$props, 'slot1'),
			slot2 = prop($$props, 'slot2');

		var div = root$1();
		var node = sibling(child(div), 2);

		snippet(node, () => slot1() ?? noop);
...

		{
			...
			var alternate = ($$anchor) => {
				...
				template_effect(() => set_text(text$1, foo()));
				append($$anchor, text$1);
			};

			if_block(node_1, ($$render) => {
				if (slot2()) $$render(consequent); else $$render(alternate, false);
			});
		}
	...
	customElements.define('qc-test', create_custom_element(
		TestWC,
		{
			foo: { attribute: 'foo' },
	...
	var root_1 = from_html(`<p>slot1</p>`);
	var root_2 = from_html(`<p>slot2</p>`);
	var root = from_html(`<div class="root qc-hash-ihd3ny"><label>OtherTest.svelte</label> <!></div>`);

	const $$css = {
		hash: 'qc-hash-ihd3ny',
		code: '.root.qc-hash-ihd3ny {border:1px solid green;padding:10px;}'
	};

	function OtherTestWC($$anchor, $$props) {
		push($$props, true);
	...
	customElements.define('qc-other-test', create_custom_element(
		OtherTestWC,
		{
			foo: { attribute: 'foo' },
			clearAriaLabel: { attribute: 'clear-aria-label' }
