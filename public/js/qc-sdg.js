	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				...
				attr(div2, "class", "qc-col-12");
				attr(div3, "class", "qc-row");
				attr(div4, "class", "qc-container");
				attr(div5, "class", "qc-general-alert " + /*typeClass*/ ctx[5]);
				attr(div5, "role", "alert");
				attr(div5, "aria-label", /*label*/ ctx[7]);
			},
			m(target, anchor) {
				insert(target, div5, anchor);
				append(div5, div4);
