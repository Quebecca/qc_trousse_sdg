(function () {
	...
	function add_css$1(target) {
		append_styles(target, "qc-hash-en2s3f", "a.qc-hash-en2s3f{color:var(--qc-color-link-text)}a.qc-hash-en2s3f:visited{color:var(--qc-color-link-visited)}a.qc-hash-en2s3f:hover{color:var(--qc-color-link-hover);text-decoration:none}a.qc-hash-en2s3f:focus{color:var(--qc-color-link-hover);text-decoration:none;outline:2px solid var(--qc-color-link-focus-outline);outline-offset:0}a.qc-hash-en2s3f:active{color:var(--qc-color-link-active);text-decoration:none}@media(max-width: 320px){}:host{display:flex;flex-direction:column;align-items:center;margin-top:4rem;padding-bottom:3.2rem;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}a.qc-hash-en2s3f{text-decoration:none}a.qc-hash-en2s3f:hover{text-decoration:underline}.copyright.qc-hash-en2s3f{margin-top:3.2rem}@media(prefers-color-scheme: dark){svg.qc-hash-en2s3f{fill:var(--qc-color-text-primary)}}");
	}
	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				...
				attr(svg, "class", "qc-hash-en2s3f");
				attr(a, "href", /*logoUrl*/ ctx[0]);
				attr(a, "class", "qc-hash-en2s3f");
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, svg);
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-en2s3f");
			},
			m(target, anchor) {
				if (default_slot) {
