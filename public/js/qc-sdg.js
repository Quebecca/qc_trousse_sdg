(function () {
	...
	function create_fragment$9(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "qc-hash-1dcrcd1");
			},
			m(target, anchor) {
	...
	class Icon extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$9, create_fragment$9, safe_not_equal, { type: 0, label: 1, size: 2, color: 3 }, add_css$6);
		}
	...
	function add_css$5(target) {
		append_styles(target, "qc-hash-cro31u", "@charset \"UTF-8\";.qc-notice.qc-information.qc-hash-cro31u .icon-container.qc-hash-cro31u{background-color:var(--qc-color-blue-pale)}.qc-notice.qc-information.qc-hash-cro31u .icon-container.qc-hash-cro31u [role=img]{background-color:var(--qc-color-blue-dark)}.qc-notice.qc-warning.qc-hash-cro31u .icon-container.qc-hash-cro31u{background-color:var(--qc-color-yellow-pale)}.qc-notice.qc-warning.qc-hash-cro31u .icon-container.qc-hash-cro31u [role=img]{background-color:var(--qc-color-yellow-dark)}.qc-notice.qc-neutral.qc-hash-cro31u .icon-container.qc-hash-cro31u{background-color:var(--qc-color-grey-pale)}.qc-notice.qc-neutral.qc-hash-cro31u .icon-container.qc-hash-cro31u [role=img]{background-color:var(--qc-color-grey-dark)}.qc-notice.qc-error.qc-hash-cro31u .icon-container.qc-hash-cro31u{background-color:var(--qc-color-red-pale)}.qc-notice.qc-error.qc-hash-cro31u .icon-container.qc-hash-cro31u [role=img]{background-color:var(--qc-color-red-dark)}.qc-notice.qc-success.qc-hash-cro31u .icon-container.qc-hash-cro31u{background-color:var(--qc-color-green-pale)}.qc-notice.qc-success.qc-hash-cro31u .icon-container.qc-hash-cro31u [role=img]{background-color:var(--qc-color-green-dark)}");
	}
	...
	function create_fragment$8(ctx) {
		...
		return {
			c() {
				...
				attr(div1, "class", "icon-container qc-hash-cro31u");
				html_tag.a = t2;
				attr(div2, "class", "text");
				attr(div3, "class", "content");
				attr(div4, "class", "content-container");
				attr(div5, "class", div5_class_value = "qc-component qc-notice qc-" + /*type*/ ctx[0] + " qc-hash-cro31u");
			...
			p(ctx, [dirty]) {
				...
				if (!current || dirty & /*type*/ 1 && div5_class_value !== (div5_class_value = "qc-component qc-notice qc-" + /*type*/ ctx[0] + " qc-hash-cro31u")) {
	...
	/* src/sdg/components/SearchBar/IconButton.svelte generated by Svelte v4.2.12 */

	function add_css$4(target) {
		append_styles(target, "qc-hash-nhni0v", "@charset \"UTF-8\";button.qc-hash-nhni0v{background:var(--qc-color-background);display:flex;align-items:center;justify-content:center;width:4rem;border:0}.sr-only.qc-hash-nhni0v{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}");
	}
	...
	function create_if_block$4(ctx) {
		...
		return {
			c() {
				span = element("span");
				t = text(/*text*/ ctx[0]);
				attr(span, "class", "sr-only qc-hash-nhni0v");
			},
			m(target, anchor) {
				insert(target, span, anchor);
				append(span, t);
	...
	function create_fragment$7(ctx) {
		...
		return {
			c() {
				...
				toggle_class(button, "qc-hash-nhni0v", true);
			},
			m(target, anchor) {
	...
	function instance$7($$self, $$props, $$invalidate) {
		const omit_props_names = ["text","srText","icon","size"];
		let $$restProps = compute_rest_props($$props, omit_props_names);
		let { text = '', srText = '', icon, size } = $$props;
		...
		return [text, srText, icon, $$restProps, size];
	}

	class IconButton extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$7, create_fragment$7, safe_not_equal, { text: 0, srText: 1, icon: 2, size: 4 }, add_css$4);
		}
	...
	create_custom_element(IconButton, {"text":{},"srText":{},"icon":{},"size":{}}, [], [], true);

	/* src/sdg/components/SearchBar/SearchInput.svelte generated by Svelte v4.2.12 */

	function add_css$3(target) {
		append_styles(target, "qc-hash-1ua1y7e", "@charset \"UTF-8\";.qc-search-input.qc-hash-1ua1y7e{height:4rem;max-width:54.8rem;background-color:var(--qc-color-background);border:1px solid var(--qc-color-formfield-border);position:relative}.search-input-border.qc-hash-1ua1y7e{display:flex;flex-grow:1;align-items:stretch;border:none;position:absolute;top:0;left:0;right:0;bottom:0;z-index:0}.search-input-border.qc-hash-1ua1y7e:has(input:focus){border:2px solid;outline:2px solid var(--qc-color-formfield-focus-outline)}input[type=search].qc-hash-1ua1y7e{font-size:var(--qc-font-size-md);line-height:var(--qc-line-height-md);font-weight:var(--qc-font-weight-regular);background:transparent;font-size:1.6rem;color:var(--qc-color-text-primary);height:auto;width:100%;padding:0.8rem 0rem 0.8rem 0.8rem;border:1px solid transparent}input[type=search].qc-hash-1ua1y7e::-webkit-search-decoration,input[type=search].qc-hash-1ua1y7e::-webkit-search-cancel-button,input[type=search].qc-hash-1ua1y7e::-webkit-search-results-button,input[type=search].qc-hash-1ua1y7e::-webkit-search-results-decoration{display:none}input[type=search].qc-hash-1ua1y7e::placeholder{color:var(--qc-color-grey-medium);font-weight:normal}input[type=search].qc-hash-1ua1y7e:focus,input[type=search].qc-hash-1ua1y7e:focus-visible{outline:none}.clear.qc-hash-1ua1y7e{background-color:transparent;display:none;cursor:pointer;border:0;justify-content:center;align-items:center;width:4rem}.clear.display.qc-hash-1ua1y7e{display:flex}");
	}
	...
	function create_if_block$3(ctx) {
		...
		iconbutton = new IconButton({
				props: { icon: "clear-input", color: "blue-piv" }
			});
	...
	function create_fragment$6(ctx) {
		...
		return {
			c() {
				...
				toggle_class(input, "qc-hash-1ua1y7e", true);
				attr(div0, "class", "search-input-border qc-hash-1ua1y7e");
				attr(div1, "class", "qc-search-input qc-hash-1ua1y7e");
			},
			m(target, anchor) {
	...
	class SearchInput extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$6, create_fragment$6, safe_not_equal, { value: 0 }, add_css$3);
		}
	...
	customElements.define("qc-search-input", create_custom_element(SearchInput, {"value":{"attribute":"value"}}, [], [], false));

	/* src/sdg/components/SearchBar/searchBar.svelte generated by Svelte v4.2.12 */

	function get_if_ctx(ctx) {
		const child_ctx = ctx.slice();
		const constants_0 = /*submitName*/ child_ctx[1];
		child_ctx[4] = constants_0;
		const constants_1 = /*submitValue*/ child_ctx[0];
		child_ctx[3] = constants_1;
		const constants_2 = /*submitText*/ child_ctx[2];
		child_ctx[8] = constants_2;
		return child_ctx;
	}
	...
	function create_if_block$2(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*submitName*/ 2) button_changes.name = /*name*/ ctx[4];
				if (dirty & /*submitValue*/ 1) button_changes.value = /*value*/ ctx[3];
				if (dirty & /*submitText*/ 4) button_changes.text = /*text*/ ctx[8];
	...
	function create_fragment$5(ctx) {
		...
		return {
			c() {
				...
				div0 = element("div");
				if (if_block) if_block.c();
				attr(div0, "class", "search-button");
				attr(div1, "class", "qc-search-bar");
			},
			m(target, anchor) {
				insert(target, div1, anchor);
				mount_component(searchinput, div1, null);
				append(div1, t);
				append(div1, div0);
				if (if_block) if_block.m(div0, null);
				current = true;
	...
	function instance$5($$self, $$props, $$invalidate) {
		...
		let { value = '', name = 'search', placeholder = lang === "fr" ? "Lancer la recherche" : "Submit search", ariaLabel = placeholder, submitValue, submitName, submitText } = $$props;
		...
		$$self.$$set = $$props => {
			...
			if ('submitValue' in $$props) $$invalidate(0, submitValue = $$props.submitValue);
			if ('submitName' in $$props) $$invalidate(1, submitName = $$props.submitName);
			if ('submitText' in $$props) $$invalidate(2, submitText = $$props.submitText);
		};

		return [submitValue, submitName, submitText, value, name, placeholder, ariaLabel];
	}
	...
	customElements.define("qc-search-bar", create_custom_element(SearchBar, {"value":{"attribute":"value","type":"String"},"name":{"attribute":"value","type":"String"},"placeholder":{},"ariaLabel":{"attribute":"aria-label","type":"String"},"submitValue":{"attribute":"submit-value","type":"String"},"submitName":{"attribute":"submit-value","type":"String"},"submitText":{"attribute":"submit-text","type":"String"}}, [], [], false));

	/* src/sdg/components/PivHeader/pivHeader.svelte generated by Svelte v4.2.12 */

	function add_css$2(target) {
		append_styles(target, "qc-hash-6gzs9w", "@charset \"UTF-8\";.qc-hash-6gzs9w.qc-hash-6gzs9w,.qc-hash-6gzs9w.qc-hash-6gzs9w::before,.qc-hash-6gzs9w.qc-hash-6gzs9w::after{box-sizing:border-box}a.qc-hash-6gzs9w.qc-hash-6gzs9w:not([class]){text-decoration-skip-ink:auto}img.qc-hash-6gzs9w.qc-hash-6gzs9w{max-width:100%;display:block}@media(prefers-reduced-motion: reduce){.qc-hash-6gzs9w.qc-hash-6gzs9w,.qc-hash-6gzs9w.qc-hash-6gzs9w::before,.qc-hash-6gzs9w.qc-hash-6gzs9w::after{animation-duration:0.01ms !important;animation-iteration-count:1 !important;transition-duration:0.01ms !important;scroll-behavior:auto !important}}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul.qc-hash-6gzs9w{list-style:none;padding:0;margin:0;height:100%;margin-left:var(--qc-spacer-md)}@media(max-width: 575.98px){.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul.qc-hash-6gzs9w{margin-left:var(--qc-spacer-sm)}}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul li.qc-hash-6gzs9w{padding:0;margin:0;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul a.qc-hash-6gzs9w{font-family:var(--qc-font-family-header);text-decoration:none;font-size:1.2rem;color:#ffffff;font-weight:var(--qc-font-weight-regular)}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul a.qc-hash-6gzs9w:focus,.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section .links ul a.qc-hash-6gzs9w:hover{text-decoration:underline;color:#ffffff}.qc-container.qc-hash-6gzs9w.qc-hash-6gzs9w,.qc-container-fluid.qc-hash-6gzs9w.qc-hash-6gzs9w{width:100%;padding-right:calc(1 * var(--qc-grid-gutter) / 2);padding-left:calc(1 * var(--qc-grid-gutter) / 2);margin-right:auto;margin-left:auto}@media(min-width: 576px){.qc-container.qc-hash-6gzs9w.qc-hash-6gzs9w{max-width:576px}}@media(min-width: 768px){.qc-container.qc-hash-6gzs9w.qc-hash-6gzs9w{max-width:768px}}@media(min-width: 992px){.qc-container.qc-hash-6gzs9w.qc-hash-6gzs9w{max-width:992px}}@media(min-width: 1200px){.qc-container.qc-hash-6gzs9w.qc-hash-6gzs9w{max-width:1200px}}.qc-piv-header.qc-hash-6gzs9w.qc-hash-6gzs9w{color:#ffffff}.qc-piv-header.qc-hash-6gzs9w a.qc-hash-6gzs9w{color:#ffffff;text-decoration:none}.qc-piv-header.qc-hash-6gzs9w a.qc-hash-6gzs9w:hover,.qc-piv-header.qc-hash-6gzs9w a.qc-hash-6gzs9w:focus{color:#ffffff;text-decoration:underline}.qc-piv-header.qc-hash-6gzs9w .piv-top.qc-hash-6gzs9w{display:flex;justify-content:space-between;align-items:center}.qc-piv-header.qc-hash-6gzs9w .piv-top .logo.qc-hash-6gzs9w{margin-right:6.4rem}@media(max-width: 575.98px){.qc-piv-header.qc-hash-6gzs9w .piv-top .logo.qc-hash-6gzs9w{margin:0}}.qc-piv-header.qc-hash-6gzs9w .piv-top .logo a.qc-hash-6gzs9w{display:block}.qc-piv-header.qc-hash-6gzs9w .piv-top .logo img.qc-hash-6gzs9w{height:7.2rem;min-width:20rem}.qc-piv-header.qc-hash-6gzs9w .piv-top .title.qc-hash-6gzs9w{width:100%;padding:var(--qc-spacer-sm) 0;min-height:7.2rem;align-items:center;display:flex;margin-right:4rem}.qc-piv-header.qc-hash-6gzs9w .piv-top .title a.qc-hash-6gzs9w{font-size:var(--qc-font-size-100);line-height:var(--qc-line-height-100);font-weight:var(--qc-font-weight-regular);font-family:var(--qc-font-family-header)}.qc-piv-header.qc-hash-6gzs9w .piv-top .title a.qc-hash-6gzs9w:hover,.qc-piv-header.qc-hash-6gzs9w .piv-top .title a.qc-hash-6gzs9w:focus{text-decoration:underline}.qc-piv-header.qc-hash-6gzs9w .piv-top .title a .description.qc-hash-6gzs9w{font-size:var(--qc-font-size-sm)}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section.qc-hash-6gzs9w{min-width:fit-content;display:flex;align-items:center}@media(max-width: 575.98px){.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section.qc-hash-6gzs9w{min-width:auto}}.qc-piv-header.qc-hash-6gzs9w .piv-top .qc-search.qc-hash-6gzs9w{background-image:url(\"data:image/svg+xml;base64,\");min-width:2.4rem;height:2.4rem}.qc-piv-header.qc-hash-6gzs9w .piv-top .qc-search span.qc-hash-6gzs9w{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}.qc-piv-header.qc-hash-6gzs9w .piv-bottom .title.qc-hash-6gzs9w{display:none}.qc-piv-header.qc-hash-6gzs9w .piv-bottom .search-zone.qc-hash-6gzs9w{padding-bottom:var(--qc-spacer-md)}.go-to-content.qc-hash-6gzs9w.qc-hash-6gzs9w{display:flex;height:0}.go-to-content.qc-hash-6gzs9w a.qc-hash-6gzs9w{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}.go-to-content.qc-hash-6gzs9w a.qc-hash-6gzs9w:focus{width:inherit;height:inherit;overflow:inherit;clip:inherit;white-space:inherit;color:#ffffff;background-color:#095797}@media(max-width: 767.98px){.qc-piv-header.qc-hash-6gzs9w .piv-top .logo img.qc-hash-6gzs9w{min-width:17.5rem;width:17.5rem}.qc-piv-header.qc-hash-6gzs9w .piv-top .title.qc-hash-6gzs9w{display:none}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section.qc-hash-6gzs9w{min-width:13rem}.qc-piv-header.qc-hash-6gzs9w .piv-bottom .title.qc-hash-6gzs9w{margin:0;display:flex;padding-bottom:var(--qc-spacer-sm);font-size:var(--qc-font-size-100);line-height:var(--qc-line-height-100);font-weight:var(--qc-font-weight-regular);font-family:var(--qc-font-family-header)}}@media(max-width: 575.98px){.qc-piv-header.qc-hash-6gzs9w .piv-top.qc-hash-6gzs9w{height:7.2rem}.qc-piv-header.qc-hash-6gzs9w .piv-top .right-section.qc-hash-6gzs9w{min-width:fit-content}}");
	}
	...
	function create_if_block_7(ctx) {
		...
		return {
			c() {
				...
				attr(a, "class", "qc-hash-6gzs9w");
				attr(div, "class", "go-to-content qc-hash-6gzs9w");
			},
			m(target, anchor) {
				insert(target, div, anchor);
				append(div, a);
	...
	function create_if_block_6(ctx) {
		...
		return {
			c() {
				...
				attr(span, "class", "qc-hash-6gzs9w");
				attr(a, "href", /*titleUrl*/ ctx[4]);
				attr(a, "class", "qc-hash-6gzs9w");
				attr(div, "class", "title qc-hash-6gzs9w");
			},
			m(target, anchor) {
				insert(target, div, anchor);
				append(div, a);
	...
	// (131:8) {#if enableSearch == 'true'}
	function create_if_block_5(ctx) {
		let a;
		let span;

		let t_value = (/*displaySearchForm*/ ctx[23]
		? /*hideSearchText*/ ctx[19]
		: /*displaySearchText*/ ctx[18]) + "";
		...
		return {
			c() {
				...
				t = text(t_value);
				attr(span, "class", "qc-hash-6gzs9w");
				attr(a, "class", "qc-search qc-hash-6gzs9w");
				attr(a, "href", "/");
				attr(a, "role", "button");
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(a, "click", prevent_default(/*click_handler*/ ctx[28])),
						listen(a, "click", /*focusOnSearchInput*/ ctx[21])
					];
			...
			p(ctx, dirty) {
				if (dirty & /*displaySearchForm, hideSearchText, displaySearchText*/ 9175040 && t_value !== (t_value = (/*displaySearchForm*/ ctx[23]
				? /*hideSearchText*/ ctx[19]
				: /*displaySearchText*/ ctx[18]) + "")) set_data(t, t_value);
			},
			d(detaching) {
				if (detaching) {
					detach(a);
	...
	// (142:10) {#if joinUsUrl || altLanguageUrl}
	function create_if_block_2(ctx) {
		...
		return {
			c() {
				...
				t = space();
				if (if_block1) if_block1.c();
				attr(ul, "class", "qc-hash-6gzs9w");
				attr(nav, "aria-label", /*linksLabel*/ ctx[6]);
				attr(nav, "class", "qc-hash-6gzs9w");
			},
			m(target, anchor) {
	...
	// (166:6) {#if displaySearchForm}
	function create_if_block$1(ctx) {
		let div;
		let current;
		const search_zone_slot_template = /*#slots*/ ctx[27]["search-zone"];
		const search_zone_slot = create_slot(search_zone_slot_template, ctx, /*$$scope*/ ctx[26], get_search_zone_slot_context);
		...
		return {
			c() {
				...
				attr(div, "class", "search-zone qc-hash-6gzs9w");
			},
			m(target, anchor) {
				insert(target, div, anchor);
			...
			p(ctx, dirty) {
				if (search_zone_slot) {
					if (search_zone_slot.p && (!current || dirty & /*$$scope*/ 67108864)) {
						update_slot_base(
							search_zone_slot,
							...
							: get_slot_changes(search_zone_slot_template, /*$$scope*/ ctx[26], dirty, get_search_zone_slot_changes),
							get_search_zone_slot_context
						);
					}
				} else {
					if (search_zone_slot_or_fallback && search_zone_slot_or_fallback.p && (!current || dirty & /*searchFormAction, searchPlaceholder, searchInputName, searchInputValue, submitSearchText*/ 1294336)) {
	...
	function fallback_block$1(ctx) {
		...
		searchbar = new SearchBar({
				props: {
					placeholder: /*searchPlaceholder*/ ctx[14],
					name: /*searchInputName*/ ctx[15],
					value: /*searchInputValue*/ ctx[16],
					submitText: /*submitSearchText*/ ctx[17]
				}
			});
		...
		return {
			c() {
				...
				attr(form, "action", /*searchFormAction*/ ctx[20]);
				attr(form, "class", "qc-hash-6gzs9w");
			},
			m(target, anchor) {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*searchPlaceholder*/ 16384) searchbar_changes.placeholder = /*searchPlaceholder*/ ctx[14];
				if (dirty & /*searchInputName*/ 32768) searchbar_changes.name = /*searchInputName*/ ctx[15];
				if (dirty & /*searchInputValue*/ 65536) searchbar_changes.value = /*searchInputValue*/ ctx[16];
				if (dirty & /*submitSearchText*/ 131072) searchbar_changes.submitText = /*submitSearchText*/ ctx[17];
				searchbar.$set(searchbar_changes);

				if (!current || dirty & /*searchFormAction*/ 1048576) {
					attr(form, "action", /*searchFormAction*/ ctx[20]);
				}
			},
			i(local) {
	...
	function create_fragment$4(ctx) {
		...
		const links_slot_template = /*#slots*/ ctx[27].links;
		const links_slot = create_slot(links_slot_template, ctx, /*$$scope*/ ctx[26], get_links_slot_context);
		const links_slot_or_fallback = links_slot || fallback_block_1$1(ctx);
		let if_block3 = /*titleText*/ ctx[5] && create_if_block_1$1(ctx);
		let if_block4 = /*displaySearchForm*/ ctx[23] && create_if_block$1(ctx);
		...
		return {
			c() {
				...
				attr(img, "class", "qc-hash-6gzs9w");
				attr(a, "href", /*logoUrl*/ ctx[1]);
				attr(a, "target", "_blank");
				attr(a, "rel", "noreferrer");
				attr(a, "class", "qc-hash-6gzs9w");
				attr(div0, "class", "logo qc-hash-6gzs9w");
				attr(div1, "class", "links qc-hash-6gzs9w");
				attr(div2, "class", "right-section qc-hash-6gzs9w");
				attr(div3, "class", "piv-top qc-hash-6gzs9w");
				attr(div4, "class", "piv-bottom qc-hash-6gzs9w");
				attr(div5, "class", div5_class_value = "" + (null_to_empty(/*containerClass*/ ctx[22]) + " qc-hash-6gzs9w"));
				attr(div6, "role", "banner");
				attr(div6, "class", "qc-piv-header qc-component qc-hash-6gzs9w");
			},
			m(target, anchor) {
			...
			p(ctx, [dirty]) {
				...
				if (links_slot) {
					if (links_slot.p && (!current || dirty & /*$$scope*/ 67108864)) {
						update_slot_base(
							links_slot,
							links_slot_template,
							ctx,
							...
							!current
							? get_all_dirty_from_scope(/*$$scope*/ ctx[26])
							: get_slot_changes(links_slot_template, /*$$scope*/ ctx[26], dirty, get_links_slot_changes),
				...
				if (/*displaySearchForm*/ ctx[23]) {
					if (if_block4) {
						if_block4.p(ctx, dirty);

						if (dirty & /*displaySearchForm*/ 8388608) {
				...
				if (!current || dirty & /*containerClass*/ 4194304 && div5_class_value !== (div5_class_value = "" + (null_to_empty(/*containerClass*/ ctx[22]) + " qc-hash-6gzs9w"))) {
					attr(div5, "class", div5_class_value);
				}
			},
			i(local) {
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		: 'Logo of government of Québec', titleUrl = '/', titleText = '', linksLabel = lang === 'fr' ? 'Navigation PIV' : 'PIV navigation', altLanguageText = lang === 'fr' ? 'English' : 'Français', altLanguageUrl = '', joinUsText = lang === 'fr' ? 'Nous joindre' : 'Contact us', joinUsUrl = '', goToContent = 'true', goToContentAnchor = '#main', goToContentText = lang === 'fr' ? 'Passer au contenu' : 'Skip to content', searchPlaceholder = lang === 'fr' ? 'Rechercher…' : 'Search…', searchInputName = 'q', searchInputValue = '', submitSearchText = lang === 'fr' ? 'Rechercher' : 'Search', displaySearchText = lang === 'fr'
		...
		onMount(() => {
			$$invalidate(22, containerClass += fullWidth === 'true' ? '-fluid' : '');

			if (showSearch === 'true') {
				$$invalidate(0, enableSearch = 'true');
				$$invalidate(23, displaySearchForm = true);
			}
		});

		const click_handler = () => $$invalidate(23, displaySearchForm = !displaySearchForm);

		$$self.$$set = $$props => {
			if ('logoUrl' in $$props) $$invalidate(1, logoUrl = $$props.logoUrl);
			if ('fullWidth' in $$props) $$invalidate(24, fullWidth = $$props.fullWidth);
			...
			if ('searchPlaceholder' in $$props) $$invalidate(14, searchPlaceholder = $$props.searchPlaceholder);
			if ('searchInputName' in $$props) $$invalidate(15, searchInputName = $$props.searchInputName);
			if ('searchInputValue' in $$props) $$invalidate(16, searchInputValue = $$props.searchInputValue);
			if ('submitSearchText' in $$props) $$invalidate(17, submitSearchText = $$props.submitSearchText);
			if ('displaySearchText' in $$props) $$invalidate(18, displaySearchText = $$props.displaySearchText);
			if ('hideSearchText' in $$props) $$invalidate(19, hideSearchText = $$props.hideSearchText);
			if ('searchFormAction' in $$props) $$invalidate(20, searchFormAction = $$props.searchFormAction);
			if ('enableSearch' in $$props) $$invalidate(0, enableSearch = $$props.enableSearch);
			if ('showSearch' in $$props) $$invalidate(25, showSearch = $$props.showSearch);
		...
		constructor(options) {
			...
			init(
				...
				safe_not_equal,
				{
					...
					searchInputValue: 16,
					submitSearchText: 17,
					displaySearchText: 18,
					hideSearchText: 19,
					searchFormAction: 20,
					enableSearch: 0,
					showSearch: 25,
					focusOnSearchInput: 21
				},
				add_css$2
			);
		}
	...
	customElements.define("qc-piv-header", create_custom_element(PivHeader, {"logoUrl":{"attribute":"logo-url"},"fullWidth":{"attribute":"full-width"},"logoSrc":{"attribute":"logo-src"},"logoAlt":{"attribute":"logo-alt"},"titleUrl":{"attribute":"title-url"},"titleText":{"attribute":"title-text"},"linksLabel":{"attribute":"links-label"},"altLanguageText":{"attribute":"alt-language-text"},"altLanguageUrl":{"attribute":"alt-language-url"},"joinUsText":{"attribute":"join-us-text"},"joinUsUrl":{"attribute":"join-us-url"},"goToContent":{"attribute":"go-to-content"},"goToContentAnchor":{"attribute":"go-to-content-anchor"},"goToContentText":{"attribute":"go-to-content-text"},"searchPlaceholder":{"attribute":"search-placeholder"},"searchInputName":{"attribute":"search-input-name"},"searchInputValue":{"attribute":"search-input-value"},"submitSearchText":{"attribute":"submit-search-text"},"displaySearchText":{"attribute":"display-search-text"},"hideSearchText":{"attribute":"hide-search-text"},"searchFormAction":{"attribute":"search-form-action"},"enableSearch":{"attribute":"enable-search"},"showSearch":{"attribute":"show-search"}}, ["links","search-zone"], ["focusOnSearchInput"], true));

	/* src/sdg/components/pivFooter.svelte generated by Svelte v4.2.12 */

	function add_css$1(target) {
		append_styles(target, "qc-hash-kfd1r1", "@charset \"UTF-8\";:root{font-size:var(--qc-font-size-root-percent)}a.qc-hash-kfd1r1{color:var(--qc-color-link-text)}a.qc-hash-kfd1r1:visited{color:var(--qc-color-link-visited)}a.qc-hash-kfd1r1:hover,a.qc-hash-kfd1r1:focus{color:var(--qc-color-link-hover);text-decoration:none}a.qc-hash-kfd1r1:active{color:var(--qc-color-link-active);text-decoration:none}:host{display:flex;flex-direction:column;align-items:center;margin-top:4rem;padding-bottom:3.2rem;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}a.qc-hash-kfd1r1{text-decoration:none}a.qc-hash-kfd1r1:hover{text-decoration:underline}.copyright.qc-hash-kfd1r1{margin-top:3.2rem}@media(prefers-color-scheme: dark){svg.qc-hash-kfd1r1{fill:var(--qc-color-text-primary)}}");
	}
	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				...
				attr(svg, "class", "qc-hash-kfd1r1");
				attr(a, "href", /*logoUrl*/ ctx[0]);
				attr(a, "class", "qc-hash-kfd1r1");
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, svg);
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-kfd1r1");
			},
			m(target, anchor) {
				if (default_slot) {
	...
	function add_css(target) {
		append_styles(target, "qc-hash-ib4vzw", "@charset \"UTF-8\";img.qc-hash-ib4vzw{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}");
	}
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(img_1, "class", "qc-hash-ib4vzw");
			},
			m(target, anchor) {
