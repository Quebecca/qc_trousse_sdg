(function () {
	...
	function Icon($$anchor, $$props) {
		...
		let type = prop($$props, 'type', 12),
			...
			size = prop($$props, 'size', 12, 'md'),
			color = prop($$props, 'color', 12, 'text-primary'),
			width = prop($$props, 'width', 12, 'auto'),
			height = prop($$props, 'height', 12, 'auto');
		...
		legacy_pre_effect(
			...
			() => {
				set(attributes, width() === "auto" ? { "data-img-size": size() } : {});
			}
		);
	...
	function Notice($$anchor, $$props) {
		...
		const role = mutable_source();
		const shouldUseIcon = mutable_source();
		const computedType = mutable_source();
		const iconType = mutable_source();
		const iconLabel = mutable_source();
		...
		let noticeElement = mutable_source();

		let title = prop($$props, 'title', 12, ""),
			type = prop($$props, 'type', 12, defaultType),
			content = prop($$props, 'content', 12, ""),
			header = prop($$props, 'header', 12, defaultHeader),
			icon = prop($$props, 'icon', 12);

		legacy_pre_effect(() => (deep_read_state(header())), () => {
			header(header().match(/h[1-6]/) ? header() : defaultHeader);
		});
		...
		legacy_pre_effect(() => (deep_read_state(type())), () => {
			set(role, type() === "success" ? "status" : type() === "error" ? "alert" : null);
		});

		legacy_pre_effect(() => (get(role), get(noticeElement)), () => {
			if (get(role)) {
				if (get(noticeElement)) {
					const tempNodes = Array.from(get(noticeElement).childNodes);

					// console.log("temp: ",tempNodes);
					mutate(noticeElement, get(noticeElement).innerHTML = "");
		...
		legacy_pre_effect(() => (deep_read_state(type())), () => {
			set(shouldUseIcon, type() === "advice" || type() === "note");
		});
		...
		legacy_pre_effect(
			...
			() => {
				set(computedType, get(shouldUseIcon) ? "neutral" : type());
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(iconType, get(shouldUseIcon) ? icon() ?? "note" : type());
			}
		);

		legacy_pre_effect(() => (deep_read_state(type())), () => {
			set(iconLabel, typesDescriptions[type()] ?? typesDescriptions['information']);
		});
...

		{
			var consequent = ($$anchor) => {
				...
				element(node_3, header, false, ($$element, $$anchor) => {
	...
	function PivHeader($$anchor, $$props) {
		...
		let logoUrl = prop($$props, 'logoUrl', 12, '/'),
			fullWidth = prop($$props, 'fullWidth', 12, 'false'),
			logoSrc = prop($$props, 'logoSrc', 28, () => Utils.imagesRelativePath + 'QUEBEC_blanc.svg'),
			logoAlt = prop($$props, 'logoAlt', 12, lang === 'fr' ? 'Logo du gouvernement du Québec' : 'Logo of government of Québec'),
			titleUrl = prop($$props, 'titleUrl', 12, '/'),
			titleText = prop($$props, 'titleText', 12, ''),
			linksLabel = prop($$props, 'linksLabel', 12, lang === 'fr' ? 'Navigation PIV' : 'PIV navigation'),
			altLanguageText = prop($$props, 'altLanguageText', 12, lang === 'fr' ? 'English' : 'Français'),
			altLanguageUrl = prop($$props, 'altLanguageUrl', 12, ''),
			joinUsText = prop($$props, 'joinUsText', 12, lang === 'fr' ? 'Nous joindre' : 'Contact us'),
			joinUsUrl = prop($$props, 'joinUsUrl', 12, ''),
			goToContent = prop($$props, 'goToContent', 12, 'true'),
			goToContentAnchor = prop($$props, 'goToContentAnchor', 12, '#main'),
			goToContentText = prop($$props, 'goToContentText', 12, lang === 'fr' ? 'Passer au contenu' : 'Skip to content'),
			displaySearchText = prop($$props, 'displaySearchText', 12, lang === 'fr' ? 'Cliquer pour faire une recherche' : 'Click to search'),
			hideSearchText = prop($$props, 'hideSearchText', 12, lang === 'fr' ? 'Masquer la barre de recherche' : 'Hide search bar'),
			enableSearch = prop($$props, 'enableSearch', 12, 'false'),
			showSearch = prop($$props, 'showSearch', 12, 'false');
		...
		let containerClass = mutable_source('qc-container'),
			displaySearchForm = mutable_source(false);
...

		{
			var consequent_2 = ($$anchor) => {
				...
				event('click', a_3, preventDefault(() => set(displaySearchForm, !get(displaySearchForm))));
				event('click', a_3, focusOnSearchInput);
				append($$anchor, a_3);
			};
		...
		template_effect(() => {
			...
			set_attribute(div_5, 'aria-label', logoAlt());
			set_attribute(link, 'href', Utils.cssPath);
		});

		append($$anchor, fragment);
		bind_prop($$props, 'focusOnSearchInput', focusOnSearchInput);
	...
	function PivFooter($$anchor, $$props) {
		...
		let logoUrl = prop($$props, 'logoUrl', 12, '/'),
			logoSrc = prop($$props, 'logoSrc', 28, () => Utils.imagesRelativePath + '/QUEBEC_couleur.svg'),
			logoSrcDarkTheme = prop($$props, 'logoSrcDarkTheme', 28, () => Utils.imagesRelativePath + '/QUEBEC_blanc.svg'),
			logoAlt = prop($$props, 'logoAlt', 12, lang === 'fr' ? 'Logo du gouvernement du Québec' : 'Logo of the Quebec government'),
			copyrightText = prop($$props, 'copyrightText', 28, () => '© Gouvernement du Québec, ' + new Date().getFullYear()),
			logoWidth = prop($$props, 'logoWidth', 12, 139),
			logoHeight = prop($$props, 'logoHeight', 12, 50),
			copyrightUrl = prop($$props, 'copyrightUrl', 12, lang === 'fr' ? 'https://www.quebec.ca/droit-auteur' : 'https://www.quebec.ca/en/copyright');
	...
	function Alert($$anchor, $$props) {
		...
		let type = prop($$props, 'type', 12, "general"),
			maskable = prop($$props, 'maskable', 12, ""),
			content = prop($$props, 'content', 12, ""),
			hide = prop($$props, 'hide', 12, "false"),
			fullWidth = prop($$props, 'fullWidth', 12, 'false');

		let rootElement = mutable_source(),
			hiddenFlag = mutable_source(),
			typeClass = type() !== "" ? type() : 'general',
			closeLabel = Utils.getPageLanguage() === 'fr' ? "Fermer l’alerte" : "Close l’alerte",
			warningLabel = Utils.getPageLanguage() === 'fr' ? "Information d'importance élevée" : "Information of high importance",
			generalLabel = Utils.getPageLanguage() === 'fr' ? "Information importante" : "Important information",
			label = type() === 'general' ? generalLabel : warningLabel,
			containerClass = mutable_source();
		...
		legacy_pre_effect(() => (deep_read_state(hide())), () => {
			set(hiddenFlag, hide() === 'true');
		});

		legacy_pre_effect(() => (deep_read_state(fullWidth())), () => {
			set(containerClass, "qc-container" + (fullWidth() === 'true' ? '-fluid' : ''));
		});
...

		{
			var consequent_1 = ($$anchor) => {
				...
				var div_2 = child(div_1);
				var node_1 = child(div_2);
				const expression = derived_safe_equal(() => type() == 'warning' ? 'warning' : 'information');
				const expression_1 = derived_safe_equal(() => type() == 'general' ? 'blue-piv' : 'yellow-dark');
	...
	function ToTop($$anchor, $$props) {
		...
		let text = prop($$props, 'text', 12, lang === 'fr' ? "Retour en haut" : "Back to top"),
			demo = prop($$props, 'demo', 12, 'false');

		let minimumScrollHeight = 0,
			lastScrollY = 0,
			visible = mutable_source(demo() === 'true'),
			lastVisible = get(visible),
			toTopElement = mutable_source();
		...
		function handleScrollUpButton() {
			...
			set(visible, lastScrollY > window.scrollY && (document.body.scrollTop > minimumScrollHeight || document.documentElement.scrollTop > minimumScrollHeight) && !pageBottom);

			if (!get(visible) && lastVisible) {
				// removing focus on visibility loss
				get(toTopElement).blur();
			}
		...
		reset(span);
		reset(a);
		bind_this(a, ($$value) => set(toTopElement, $$value), () => get(toTopElement));
	...
	function ExternalLink($$anchor, $$props) {
		...
		let externalIconAlt = prop($$props, 'externalIconAlt', 28, () => Utils.getPageLanguage() == "fr" ? "Ce lien dirige vers un autre site." : "This link directs to another site.");
		let imgElement = mutable_source();
	...
	function SearchInput($$anchor, $$props) {
		...
		const $$restProps = legacy_rest_props($$sanitized_props, ['value', 'ariaLabel', 'clearAriaLabel']);
		...
		let value = prop($$props, 'value', 12),
			ariaLabel = prop($$props, 'ariaLabel', 12, lang === "fr" ? "Rechercher…" : "Search_"),
			clearAriaLabel = prop($$props, 'clearAriaLabel', 12, lang === "fr" ? "Effacer le texte" : "Clear text");

		let searchInput = mutable_source();
	...
	function SearchBar($$anchor, $$props) {
		...
		const $$restProps = legacy_rest_props($$sanitized_props, ['value', 'name', 'pivBackground']);
		...
		let value = prop($$props, 'value', 12, ''),
			name = prop($$props, 'name', 12, 'q'),
			pivBackground = prop($$props, 'pivBackground', 12, false);
		...
		let defaultsAttributes = {
			...
			inputProps = mutable_source({}),
			submitProps = mutable_source({});
		...
		legacy_pre_effect(
			...
			() => {
				(($$value) => (
					set(inputProps, $$value[0]),
					set(submitProps, $$value[1])
				))(computeFieldsAttributes($$restProps));
			}
		);
		...
		{
			var consequent = ($$anchor) => {
				const expression = derived_safe_equal(() => pivBackground() ? 'blue-piv' : 'background');
		...
		template_effect(
			($0) => classes = set_class(div, 1, 'qc-search-bar', null, classes, $0),
			[
