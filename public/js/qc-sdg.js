(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-918p2j"><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-918p2j" href="#top"><!></a></div>`), Tooltip[FILENAME], [[327, 4, [[342, 8], [345, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-918p2j" role="button" tabindex="-1"><!></span>`), Tooltip[FILENAME], [[265, 5]]);
	...
	var root_4 = add_locations(
		...
		Tooltip[FILENAME],
		[[287, 9, [[290, 13, [[296, 16], [304, 16], [307, 16]]]]]]
	);

	var root_3 = add_locations(from_html(`<div><a role="button" class="qc-tooltip-button qc-hash-918p2j" href="#top"><!></a> <!> <dialog class="qc-hash-918p2j"><div class="qc-container qc-hash-918p2j"><!></div></dialog></div>`), Tooltip[FILENAME], [[272, 5, [[277, 9], [314, 9, [[317, 12]]]]]]);
	var root$1 = add_locations(from_html(`<span class="qc-tooltip qc-hash-918p2j"><!> <!></span>`), Tooltip[FILENAME], [[259, 0]]);

	const $$css = {
		hash: 'qc-hash-918p2j',
		code: '\n    .qc-tooltip.qc-hash-918p2j {\n        display: inline-flex;\n        align-items: center;\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .qc-tooltip-text.qc-hash-918p2j {\n        border-bottom: 1px dashed var(--qc-color-text-primary);\n        cursor: pointer;\n    }\n    .qc-tooltip-button.qc-hash-918p2j {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        margin-left: 4px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-918p2j {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-918p2j {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-918p2j {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-918p2j {\n        overflow-y: auto;\n        max-height:calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right:16px;\n    }\n\n    .qc-tooltip-content.qc-hash-918p2j:focus-visible {\n        outline: 2px solid var(--qc-color-blue-regular);\n        outline-offset: 1px;\n    }\n\n    .qc-tooltip-xclose.qc-hash-918p2j {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n\n    dialog.qc-hash-918p2j {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n        .qc-tooltip-panel:where(.qc-hash-918p2j) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-918p2j) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-918p2j {\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        max-width: var(--qc-max-content-width);\n        padding: 24px 0;\n    }\n\n    .qc-tooltip-popover.qc-hash-918p2j {\n\n        .qc-tooltip-content:where(.qc-hash-918p2j) {\n            padding-top: 2px;\n        }\n        .qc-tooltip-panel:where(.qc-hash-918p2j) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding: 22px 8px 24px 16px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-918p2j) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-918p2j) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            left: calc(var(--pin-height) - 1px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-918p2j) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            left: 8px;\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-918p2j) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-918p2j) {\n            visibility: visible;\n        }\n    }\n\n    .qc-hash-918p2j::-webkit-scrollbar,\n    .qc-hash-918p2j::-webkit-scrollbar-track,\n    .qc-hash-918p2j::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-918p2j::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => Icon(node_1, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 350, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
...

		{
			var consequent_2 = ($$anchor) => {
				...
				add_svelte_meta(() => Icon(node_5, { type: 'info-tooltip', size: 'sm' }), 'component', Tooltip, 284, 12, { componentTag: 'Icon' });
				reset(a_1);
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_7, () => "popover"), 'render', Tooltip, 312, 13);
				...
				add_svelte_meta(() => tooltipPanelSnippet(node_8, () => "modal"), 'render', Tooltip, 318, 16);
				reset(div_4);
				reset(dialog);
