(function () {
	...
	class Notice extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$5, create_fragment$5, safe_not_equal, { title: 2, type: 0, content: 3, header: 1 });
		}
	...
	function add_css$2(target) {
		append_styles(target, "qc-hash-4xs3j9", ".qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-hash-4xs3j9.qc-hash-4xs3j9::before,.qc-hash-4xs3j9.qc-hash-4xs3j9::after{box-sizing:border-box}a.qc-hash-4xs3j9.qc-hash-4xs3j9:not([class]){text-decoration-skip-ink:auto}img.qc-hash-4xs3j9.qc-hash-4xs3j9{max-width:100%;display:block}input.qc-hash-4xs3j9.qc-hash-4xs3j9,button.qc-hash-4xs3j9.qc-hash-4xs3j9{font:inherit}@media(prefers-reduced-motion: reduce){.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-hash-4xs3j9.qc-hash-4xs3j9::before,.qc-hash-4xs3j9.qc-hash-4xs3j9::after{animation-duration:0.01ms !important;animation-iteration-count:1 !important;transition-duration:0.01ms !important;scroll-behavior:auto !important}}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul.qc-hash-4xs3j9{list-style:none;padding:0;margin:0;height:100%;margin-left:var(--qc-spacer-md)}@media(max-width: 575.98px){.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul.qc-hash-4xs3j9{margin-left:var(--qc-spacer-sm)}}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul li.qc-hash-4xs3j9{padding:0;margin:0;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul a.qc-hash-4xs3j9{font-family:var(--qc-font-family-header);text-decoration:none;font-size:1.2rem;color:var(--qc-color-white);font-weight:var(--qc-font-weight-regular)}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul a.qc-hash-4xs3j9:focus,.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section .links ul a.qc-hash-4xs3j9:hover{text-decoration:underline;color:var(--qc-color-white)}:host{display:block;min-height:7.2rem;background-color:var(--qc-color-blue-piv);width:100%}.qc-container.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-container-fluid.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-container-xl.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-container-lg.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-container-md.qc-hash-4xs3j9.qc-hash-4xs3j9,.qc-container-sm.qc-hash-4xs3j9.qc-hash-4xs3j9{width:100%;padding-right:calc(1 * var(--qc-grid-gutter) / 2);padding-left:calc(1 * var(--qc-grid-gutter) / 2);margin-right:auto;margin-left:auto}@media(min-width: 576px){.qc-container.qc-hash-4xs3j9.qc-hash-4xs3j9{max-width:576px}}@media(min-width: 768px){.qc-container.qc-hash-4xs3j9.qc-hash-4xs3j9{max-width:768px}}@media(min-width: 992px){.qc-container.qc-hash-4xs3j9.qc-hash-4xs3j9{max-width:992px}}@media(min-width: 1200px){.qc-container.qc-hash-4xs3j9.qc-hash-4xs3j9{max-width:1200px}}.qc-piv-header.qc-hash-4xs3j9.qc-hash-4xs3j9{color:var(--qc-color-white)}.qc-piv-header.qc-hash-4xs3j9 a.qc-hash-4xs3j9{color:var(--qc-color-white);text-decoration:none}.qc-piv-header.qc-hash-4xs3j9 a.qc-hash-4xs3j9:hover,.qc-piv-header.qc-hash-4xs3j9 a.qc-hash-4xs3j9:focus{color:var(--qc-color-white);text-decoration:underline}.qc-piv-header.qc-hash-4xs3j9 .piv-top.qc-hash-4xs3j9{display:flex;justify-content:space-between;align-items:center}.qc-piv-header.qc-hash-4xs3j9 .piv-top .logo.qc-hash-4xs3j9{margin-right:6.4rem}@media(max-width: 575.98px){.qc-piv-header.qc-hash-4xs3j9 .piv-top .logo.qc-hash-4xs3j9{margin:0}}.qc-piv-header.qc-hash-4xs3j9 .piv-top .logo a.qc-hash-4xs3j9{display:block}.qc-piv-header.qc-hash-4xs3j9 .piv-top .logo img.qc-hash-4xs3j9{height:7.2rem;min-width:20rem}.qc-piv-header.qc-hash-4xs3j9 .piv-top .title.qc-hash-4xs3j9{width:100%;padding:var(--qc-spacer-sm) 0;min-height:7.2rem;align-items:center;display:flex;margin-right:4rem}.qc-piv-header.qc-hash-4xs3j9 .piv-top .title a.qc-hash-4xs3j9{font-size:var(--qc-font-size-100);line-height:var(--qc-line-height-100);font-weight:var(--qc-font-weight-regular);font-family:var(--qc-font-family-header)}.qc-piv-header.qc-hash-4xs3j9 .piv-top .title a.qc-hash-4xs3j9:hover,.qc-piv-header.qc-hash-4xs3j9 .piv-top .title a.qc-hash-4xs3j9:focus{text-decoration:underline}.qc-piv-header.qc-hash-4xs3j9 .piv-top .title a .description.qc-hash-4xs3j9{font-size:var(--qc-font-size-sm)}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section.qc-hash-4xs3j9{min-width:fit-content;display:flex;align-items:center}@media(max-width: 575.98px){.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section.qc-hash-4xs3j9{min-width:auto}}.qc-piv-header.qc-hash-4xs3j9 .piv-top .qc-search.qc-hash-4xs3j9{background-image:url(\"data:image/svg+xml;base64,\");min-width:2.4rem;height:2.4rem}.qc-piv-header.qc-hash-4xs3j9 .piv-top .qc-search span.qc-hash-4xs3j9{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .title.qc-hash-4xs3j9{display:none}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone.qc-hash-4xs3j9{padding-bottom:var(--qc-spacer-md)}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group.qc-hash-4xs3j9{width:100%;display:flex;justify-content:space-between;align-items:stretch}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group input.qc-hash-4xs3j9{width:100%;padding:0.6rem 1.2rem;border:1px solid var(--qc-color-blue-dark);border-right:none}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group input.qc-hash-4xs3j9:focus{outline:0.2rem solid var(--qc-color-blue-light);border-right:1px solid black;z-index:1}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group input.qc-hash-4xs3j9::placeholder{font-size:var(--qc-font-size-sm)}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group button.qc-hash-4xs3j9{display:flex;justify-content:center;border:1px solid var(--qc-color-blue-dark);border-left:none;background-color:white;width:4.16rem}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group button.qc-hash-4xs3j9:focus{outline:0.2rem solid var(--qc-color-blue-light);border-left:1px solid black}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group button .qc-search-submit.qc-hash-4xs3j9{min-width:2.4rem;height:2.4rem;align-self:center}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .search-zone form .input-group button .sr-description.qc-hash-4xs3j9{position:absolute;width:1px;height:1px;clip:rect(0 0 0 0)}.go-to-content.qc-hash-4xs3j9.qc-hash-4xs3j9{display:flex;height:0}.go-to-content.qc-hash-4xs3j9 a.qc-hash-4xs3j9{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}.go-to-content.qc-hash-4xs3j9 a.qc-hash-4xs3j9:focus{width:inherit;height:inherit;overflow:inherit;clip:inherit;white-space:inherit;color:var(--qc-color-white);background-color:var(--qc-color-blue-piv)}@media(max-width: 767.98px){.qc-piv-header.qc-hash-4xs3j9 .piv-top .logo img.qc-hash-4xs3j9{min-width:17.5rem;width:17.5rem}.qc-piv-header.qc-hash-4xs3j9 .piv-top .title.qc-hash-4xs3j9{display:none}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section.qc-hash-4xs3j9{min-width:13rem}.qc-piv-header.qc-hash-4xs3j9 .piv-bottom .title.qc-hash-4xs3j9{margin:0;display:flex;padding-bottom:var(--qc-spacer-sm);font-size:var(--qc-font-size-100);line-height:var(--qc-line-height-100);font-weight:var(--qc-font-weight-regular);font-family:var(--qc-font-family-header)}}@media(max-width: 575.98px){.qc-piv-header.qc-hash-4xs3j9 .piv-top.qc-hash-4xs3j9{height:7.2rem}.qc-piv-header.qc-hash-4xs3j9 .piv-top .right-section.qc-hash-4xs3j9{min-width:fit-content}}");
	}
	...
	function create_if_block_7(ctx) {
		...
		return {
			c() {
				...
				attr(a, "class", "qc-hash-4xs3j9");
				attr(div, "class", "go-to-content qc-hash-4xs3j9");
			},
			m(target, anchor) {
	...
	function create_if_block_6(ctx) {
		...
		return {
			c() {
				...
				attr(span, "class", "qc-hash-4xs3j9");
				attr(a, "href", /*titleUrl*/ ctx[4]);
				attr(a, "class", "qc-hash-4xs3j9");
				attr(div, "class", "title qc-hash-4xs3j9");
			},
			m(target, anchor) {
				insert(target, div, anchor);
				append(div, a);
	...
	// (129:8) {#if enableSearch == 'true'}
	function create_if_block_5(ctx) {
		let a;
		let span;

		let t_value = (/*displaySearchForm*/ ctx[22]
		? /*hideSearchText*/ ctx[18]
		: /*displaySearchText*/ ctx[17]) + "";
		...
		return {
			c() {
				...
				t = text(t_value);
				attr(span, "class", "qc-hash-4xs3j9");
				attr(a, "class", "qc-search qc-hash-4xs3j9");
				attr(a, "href", "/");
				attr(a, "role", "button");
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen(a, "click", /*focusOnSearchInput*/ ctx[20])
					];
			...
			p(ctx, dirty) {
				if (dirty & /*displaySearchForm, hideSearchText, displaySearchText*/ 4587520 && t_value !== (t_value = (/*displaySearchForm*/ ctx[22]
				? /*hideSearchText*/ ctx[18]
				: /*displaySearchText*/ ctx[17]) + "")) set_data(t, t_value);
			},
			d(detaching) {
				if (detaching) {
					detach(a);
	...
	// (140:10) {#if joinUsUrl || altLanguageUrl}
	function create_if_block_2(ctx) {
		...
		return {
			c() {
				...
				attr(ul, "class", "qc-hash-4xs3j9");
				attr(nav, "aria-label", /*linksLabel*/ ctx[6]);
				attr(nav, "class", "qc-hash-4xs3j9");
			},
			m(target, anchor) {
	...
	function create_if_block$1(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "search-zone qc-hash-4xs3j9");
			},
			m(target, anchor) {
				insert(target, div, anchor);
			...
			p(ctx, dirty) {
				if (search_zone_slot) {
					...
					if (search_zone_slot_or_fallback && search_zone_slot_or_fallback.p && (!current || dirty & /*searchFormAction, submitSearchText, searchPlaceholder, searchInputName, searchInput*/ 9027584)) {
	...
	function fallback_block$1(ctx) {
		...
		return {
			c() {
				...
				t1 = space();
				span1 = element("span");
				t2 = text(/*submitSearchText*/ ctx[16]);
				attr(input, "type", "text");
				attr(input, "placeholder", /*searchPlaceholder*/ ctx[14]);
				attr(input, "name", /*searchInputName*/ ctx[15]);
				attr(input, "class", "qc-hash-4xs3j9");
				attr(span0, "class", "qc-icon qc-search-submit qc-hash-4xs3j9");
				attr(span1, "class", "sr-description qc-hash-4xs3j9");
				attr(button, "class", "qc-hash-4xs3j9");
				attr(div, "class", "input-group qc-hash-4xs3j9");
				attr(form, "method", "get");
				attr(form, "action", /*searchFormAction*/ ctx[19]);
				attr(form, "class", "qc-hash-4xs3j9");
			},
			m(target, anchor) {
			...
			p(ctx, dirty) {
				if (dirty & /*searchPlaceholder*/ 16384) {
					attr(input, "placeholder", /*searchPlaceholder*/ ctx[14]);
				}

				if (dirty & /*searchInputName*/ 32768) {
					attr(input, "name", /*searchInputName*/ ctx[15]);
				}

				if (dirty & /*submitSearchText*/ 65536) set_data(t2, /*submitSearchText*/ ctx[16]);

				if (dirty & /*searchFormAction*/ 524288) {
					attr(form, "action", /*searchFormAction*/ ctx[19]);
				}
			},
			d(detaching) {
	...
	function create_fragment$4(ctx) {
		...
		let if_block4 = /*displaySearchForm*/ ctx[22] && create_if_block$1(ctx);
		...
		return {
			c() {
				...
				attr(img, "class", "qc-hash-4xs3j9");
				attr(a, "href", /*logoUrl*/ ctx[1]);
				attr(a, "target", "_blank");
				attr(a, "rel", "noreferrer");
				attr(a, "class", "qc-hash-4xs3j9");
				attr(div0, "class", "logo qc-hash-4xs3j9");
				attr(div1, "class", "links qc-hash-4xs3j9");
				attr(div2, "class", "right-section qc-hash-4xs3j9");
				attr(div3, "class", "piv-top qc-hash-4xs3j9");
				attr(div4, "class", "piv-bottom qc-hash-4xs3j9");
				attr(div5, "class", div5_class_value = "" + (null_to_empty(/*containerClass*/ ctx[21]) + " qc-hash-4xs3j9"));
				attr(div6, "role", "banner");
				attr(div6, "class", "qc-piv-header qc-component qc-hash-4xs3j9");
			},
			m(target, anchor) {
			...
			p(ctx, [dirty]) {
				...
				if (/*displaySearchForm*/ ctx[22]) {
					if (if_block4) {
						if_block4.p(ctx, dirty);

						if (dirty & /*displaySearchForm*/ 4194304) {
				...
				if (!current || dirty & /*containerClass*/ 2097152 && div5_class_value !== (div5_class_value = "" + (null_to_empty(/*containerClass*/ ctx[21]) + " qc-hash-4xs3j9"))) {
					attr(div5, "class", div5_class_value);
				}
			},
			i(local) {
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		: 'Logo of government of Québec', titleUrl = '/', titleText = '', linksLabel = lang === 'fr' ? 'Navigation PIV' : 'PIV navigation', altLanguageText = lang === 'fr' ? 'English' : 'Français', altLanguageUrl = '', joinUsText = lang === 'fr' ? 'Nous joindre' : 'Contact us', joinUsUrl = '', goToContent = 'true', goToContentAnchor = '#main', goToContentText = lang === 'fr' ? 'Passer au contenu' : 'Skip to content', searchPlaceholder = lang === 'fr' ? 'Rechercher…' : 'Search…', searchInputName = 'q', submitSearchText = lang === 'fr' ? 'Rechercher' : 'Search', displaySearchText = lang === 'fr'
		...
		onMount(() => {
			$$invalidate(21, containerClass += fullWidth === 'true' ? '-fluid' : '');

			if (showSearch === 'true') {
				$$invalidate(0, enableSearch = 'true');
				$$invalidate(22, displaySearchForm = true);
			}
		});

		const click_handler = () => $$invalidate(22, displaySearchForm = !displaySearchForm);

		function input_binding($$value) {
			binding_callbacks[$$value ? 'unshift' : 'push'](() => {
				searchInput = $$value;
				$$invalidate(23, searchInput);
			});
		}
		...
		$$self.$$set = $$props => {
			...
			if ('submitSearchText' in $$props) $$invalidate(16, submitSearchText = $$props.submitSearchText);
			if ('displaySearchText' in $$props) $$invalidate(17, displaySearchText = $$props.displaySearchText);
			if ('hideSearchText' in $$props) $$invalidate(18, hideSearchText = $$props.hideSearchText);
			if ('searchFormAction' in $$props) $$invalidate(19, searchFormAction = $$props.searchFormAction);
		...
		constructor(options) {
			...
			init(
				...
				safe_not_equal,
				{
					...
					searchInputName: 15,
					submitSearchText: 16,
					displaySearchText: 17,
					hideSearchText: 18,
					searchFormAction: 19,
					enableSearch: 0,
					showSearch: 25,
					focusOnSearchInput: 20
				},
				add_css$2
			);
		}
	...
	function add_css$1(target) {
		append_styles(target, "qc-hash-8otkj8", ":root{font-size:var(--qc-font-size-root-percent)}img.qc-hash-8otkj8.qc-hash-8otkj8{border:none;vertical-align:middle}a.qc-hash-8otkj8.qc-hash-8otkj8{color:var(--qc-color-link-text)}a.qc-hash-8otkj8.qc-hash-8otkj8:visited{color:var(--qc-color-link-visited)}a.qc-hash-8otkj8.qc-hash-8otkj8:hover,a.qc-hash-8otkj8.qc-hash-8otkj8:focus{color:var(--qc-color-link-hover);text-decoration:none}a.qc-hash-8otkj8.qc-hash-8otkj8:active{color:var(--qc-color-link-active);text-decoration:none}a.qc-hash-8otkj8 .qc-external-link-tail img.qc-hash-8otkj8{max-height:1.1rem;max-width:1.1rem;margin-bottom:0.16rem;display:inline-block;content:url(\"data:image/svg+xml;base64,\")}:host{display:flex;flex-direction:column;align-items:center;margin-top:4rem;padding-bottom:3.2rem;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}a.qc-hash-8otkj8.qc-hash-8otkj8{text-decoration:none}a.qc-hash-8otkj8.qc-hash-8otkj8:hover{text-decoration:underline}.copyright.qc-hash-8otkj8.qc-hash-8otkj8{margin-top:3.2rem}");
	}
	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				a = element("a");
				img = element("img");
				attr(img, "class", "logo-mo qc-hash-8otkj8");
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-8otkj8");
			},
			m(target, anchor) {
				if (default_slot) {
	...
	function add_css(target) {
		append_styles(target, "qc-hash-9np9x8", "img.qc-hash-9np9x8{max-height:1.1rem;max-width:1.1rem;margin-bottom:0.16rem;display:inline-block;content:url(\"data:image/svg+xml;base64,\");margin-left:0.4rem}");
	}
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(img_1, "class", "qc-hash-9np9x8");
			},
			m(target, anchor) {
