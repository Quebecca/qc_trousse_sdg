	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				a = element("a");
				img = element("img");
				attr(img, "class", "logo-mo qc-hash-ot0kim");
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-ot0kim");
			},
			m(target, anchor) {
				if (default_slot) {
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(img_1, "class", "qc-hash-1rcrqli");
			},
			m(target, anchor) {
