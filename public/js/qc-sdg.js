(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-7pesgj"><!><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-7pesgj" href="#top"><!></a></div>`), Tooltip[FILENAME], [[357, 4, [[366, 8], [369, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-7pesgj" role="button" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[288, 5]]);
	...
	var root_4 = add_locations(
		...
		Tooltip[FILENAME],
		[[316, 9, [[319, 13, [[325, 16], [333, 16], [336, 16]]]]]]
	);

	var root_3 = add_locations(from_html(`<div><a role="button" class="qc-tooltip-button qc-hash-7pesgj" href="#top"><!></a> <!> <dialog><div class="qc-container qc-hash-7pesgj"><!></div></dialog></div>`), Tooltip[FILENAME], [[295, 5, [[300, 9], [343, 9, [[347, 12]]]]]]);
	var root$1 = add_locations(from_html(`<span class="qc-tooltip qc-hash-7pesgj"><!> <!></span>`), Tooltip[FILENAME], [[275, 0]]);

	const $$css = {
		hash: 'qc-hash-7pesgj',
		code: '\n    .qc-tooltip.qc-hash-7pesgj {\n        display: inline-flex;\n        align-items: center;\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .qc-tooltip-text.qc-hash-7pesgj {\n        border-bottom: 1px dashed var(--qc-color-text-primary);\n        cursor: pointer;\n        white-space: nowrap;\n    }\n    .qc-tooltip-button.qc-hash-7pesgj {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        margin-left: 4px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-7pesgj {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-7pesgj {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-7pesgj {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-7pesgj {\n        overflow-y: auto;\n        max-height:calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right:16px;\n        padding-top: 2px;\n    }\n\n    .qc-tooltip-content.qc-hash-7pesgj:focus-visible {\n        outline: none;\n    }\n\n    .qc-tooltip-xclose.qc-hash-7pesgj {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n    dialog.qc-hash-7pesgj {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n\n        &.qc-desktop {\n            padding-top: 8px;\n        }\n\n        .qc-tooltip-panel:where(.qc-hash-7pesgj) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-7pesgj) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-7pesgj {\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        max-width: var(--qc-max-content-width);\n        padding-top: 22px;\n        padding-bottom: 24px;\n    }\n\n    .qc-tooltip-popover.qc-hash-7pesgj {\n\n        .qc-tooltip-panel:where(.qc-hash-7pesgj) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding-right: 8px;\n            padding-left: 16px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-7pesgj) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-7pesgj) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            left: calc(var(--pin-height) - 1px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-7pesgj) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            left: 8px;\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-7pesgj) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-7pesgj) {\n            visibility: visible;\n        }\n\n        .qc-tooltip-content:where(.qc-hash-7pesgj):focus-visible {\n            outline: 2px solid var(--qc-color-blue-regular);\n            outline-offset: 1px;\n        }\n    }\n\n    .qc-hash-7pesgj::-webkit-scrollbar,\n    .qc-hash-7pesgj::-webkit-scrollbar-track,\n    .qc-hash-7pesgj::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-7pesgj::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 367, 31);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 379, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
		...
		onMount((_) => {
			...
			console.log(...log_if_contains_state('log', "sm bp", getSmBreakpoint(gridConfig)));
			setIsMobile();
		...
		function setIsMobile() {
			...
			console.log(...log_if_contains_state('log', "isMobile ? : " + get(mobileFlag), bounds.right, getSmBreakpoint(gridConfig)));
		...
		function consoleName(element) {
			return equals(element, get(tooltipButton)) ? "button" : "panel";
		}
...

		{
			var consequent = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_5, textSlot), 'render', Tooltip, 292, 21);
				reset(span_1);
				append($$anchor, span_1);
			};
...

		{
			var consequent_2 = ($$anchor) => {
				...
				add_svelte_meta(() => Icon(node_7, { type: 'info-tooltip', size: 'sm' }), 'component', Tooltip, 313, 12, { componentTag: 'Icon' });
				reset(a_1);
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 341, 9);
				...
				add_svelte_meta(() => tooltipPanelSnippet(node_10, () => "modal"), 'render', Tooltip, 348, 16);
				reset(div_4);
				reset(dialog);
