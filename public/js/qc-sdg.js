(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-6uobsq"><!><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-6uobsq" href="#top"><!></a></div>`), Tooltip[FILENAME], [[401, 4, [[410, 8], [413, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-6uobsq" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[326, 5]]);
	var root_3 = add_locations(from_html(`<span class="qc-hash-6uobsq">&zwj;</span>`), Tooltip[FILENAME], [[331, 8]]);
	...
	var root_5 = add_locations(
		...
		Tooltip[FILENAME],
		[[357, 9, [[361, 13, [[367, 16], [375, 16], [378, 16]]]]]]
	);

	var root_6 = add_locations(from_html(`<dialog><div class="qc-container qc-hash-6uobsq"><!></div></dialog>`), Tooltip[FILENAME], [[386, 9, [[390, 12]]]]);
	var root_4 = add_locations(from_html(`<div><a role="button" class="qc-tooltip-button qc-hash-6uobsq" href="#top"><!></a> <!> <!></div>`), Tooltip[FILENAME], [[335, 5, [[340, 9]]]]);
	var root$1 = add_locations(from_html(`<div class="qc-tooltip qc-hash-6uobsq"><!> <!></div>`), Tooltip[FILENAME], [[313, 0]]);

	const $$css = {
		hash: 'qc-hash-6uobsq',
		code: '\n    .qc-tooltip.qc-hash-6uobsq {\n        display: inline-flex;\n        align-items: center;\n\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .qc-tooltip-text.qc-hash-6uobsq {\n        border-bottom: 1px dashed var(--qc-color-text-primary);\n        cursor: pointer;\n        white-space: nowrap;\n        margin-right: calc( .5 * var(--qc-spacer-xs) );\n    }\n    .qc-tooltip-button.qc-hash-6uobsq {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-6uobsq {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-6uobsq {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-6uobsq {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-6uobsq {\n        overflow-y: auto;\n        max-height:calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right:16px;\n        padding-top: 2px;\n    }\n\n    .qc-tooltip-content.qc-hash-6uobsq:focus-visible {\n        outline: none;\n    }\n\n    .qc-tooltip-xclose.qc-hash-6uobsq {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n    dialog.qc-hash-6uobsq {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n\n        &.qc-desktop {\n            padding-top: 8px;\n        }\n\n        .qc-tooltip-panel:where(.qc-hash-6uobsq) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-6uobsq) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-6uobsq {\n        font-size: var(--qc-font-size-sm);\n        line-height: var(--qc-line-height-sm);\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        max-width: var(--qc-max-content-width);\n        padding-top: 22px;\n        padding-bottom: 24px;\n    }\n\n    .qc-tooltip-popover.qc-hash-6uobsq {\n\n        .qc-tooltip-panel:where(.qc-hash-6uobsq) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding-right: 8px;\n            padding-left: 16px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-6uobsq) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-6uobsq) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            left: calc(var(--pin-height) - 1px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-6uobsq) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            left: 8px;\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-6uobsq) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-6uobsq) {\n            visibility: visible;\n        }\n\n        .qc-tooltip-content:where(.qc-hash-6uobsq):focus-visible {\n            outline: 2px solid var(--qc-color-blue-regular);\n            outline-offset: 1px;\n        }\n    }\n\n    .qc-hash-6uobsq::-webkit-scrollbar,\n    .qc-hash-6uobsq::-webkit-scrollbar-track,\n    .qc-hash-6uobsq::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-6uobsq::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 411, 31);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 424, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
		...
		function closeOnTooltipBlur(e) {
			...
			console.log("closeOnTooltipBlur", strict_equals(e.tooltipContainer, undefined));
...

		{
			var consequent = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_5, textSlot), 'render', Tooltip, 329, 21);
				reset(span);
				append($$anchor, span);
			};
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 383, 9);
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_11, () => "modal"), 'render', Tooltip, 391, 16);
						reset(div_5);
						reset(dialog);
