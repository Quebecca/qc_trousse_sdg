var qcSdg = (function (exports) {
  ...
  */
  ...
  function create_if_block_8(ctx) {
  	...
  	let t0;
  	let t1;
  	let if_block = /*titleDescription*/ ctx[5] && create_if_block_9(ctx);

  	return {
  		c() {
  			a = element("a");
  			span = element("span");
  			t0 = text(/*titleText*/ ctx[4]);
  			t1 = space();
  			if (if_block) if_block.c();
  		...
  		p(ctx, dirty) {
  			if (dirty & /*titleText*/ 16) set_data(t0, /*titleText*/ ctx[4]);

  			if (/*titleDescription*/ ctx[5]) {
  				if (if_block) {
  					if_block.p(ctx, dirty);
  				} else {
  ...
  function create_if_block_9(ctx) {
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			if (dirty & /*titleDescription*/ 32) set_data(t, /*titleDescription*/ ctx[5]);
  		},
  		d(detaching) {
  ...
  // (83:10) {#if joinUsUrl || altLanguageUrl}
  function create_if_block_5(ctx) {
  	let ul;
  	let t;
  	let if_block0 = /*altLanguageUrl*/ ctx[7] && create_if_block_7(ctx);
  	let if_block1 = /*joinUsUrl*/ ctx[9] && create_if_block_6(ctx);
  ...
  function create_if_block_3(ctx) {
  	...
  	let t0;
  	let t1;
  	let if_block = /*titleDescription*/ ctx[5] && create_if_block_4(ctx);
  ...
  // (113:6) {#if Utils.slotExiste(slots, 'smSearchButton')}
  function create_if_block_2(ctx) {
  	...
  	return {
  		c() {
  			div = element("div");
  			div.innerHTML = `<slot name="smSearchButton"></slot>`;
  ...
  // (119:4) {#if Utils.slotExiste(slots, 'searchZone')}
  function create_if_block_1(ctx) {
  	...
  	return {
  		c() {
  			div = element("div");
  			div.innerHTML = `<slot name="searchZone"></slot>`;
  ...
  // (124:6) {#if Utils.slotExiste(slots, 'pivBottom')}
  function create_if_block(ctx) {
  	...
  	return {
  		c() {
  			div = element("div");
  			div.innerHTML = `<slot name="pivBottom"></slot>`;
  			attr(div, "class", "piv-bottom-slot");
  		},
  		m(target, anchor) {
  			insert(target, div, anchor);
  		},
  ...
  function create_fragment(ctx) {
  	...
  	let slot3;
  	let t5;
  	let show_if_2 = Utils.slotExiste(/*slots*/ ctx[13], 'smSearchButton');
  	let t6;
  	let show_if_1 = Utils.slotExiste(/*slots*/ ctx[13], 'searchZone');
  	let t7;
  	let show_if = Utils.slotExiste(/*slots*/ ctx[13], 'pivBottom');
  	let t8;
  	let link;
  	let if_block0 = /*goToContent*/ ctx[10] && create_if_block_10(ctx);
  	let if_block1 = /*titleText*/ ctx[4] && create_if_block_8(ctx);
  	let if_block2 = (/*joinUsUrl*/ ctx[9] || /*altLanguageUrl*/ ctx[7]) && create_if_block_5(ctx);
  	let if_block3 = /*titleText*/ ctx[4] && create_if_block_3(ctx);
  	let if_block4 = show_if_2 && create_if_block_2();
  	let if_block5 = show_if_1 && create_if_block_1();
  	let if_block6 = show_if && create_if_block();
  	...
  	return {
  		c() {
  			...
  			attr(div7, "class", /*containerClass*/ ctx[15]);
  			attr(div8, "class", "qc-piv-header qc-component");
  			toggle_class(div8, "qc-d-none", !/*mounted*/ ctx[14]);
  			attr(link, "rel", "stylesheet");
  			attr(link, "href", "" + (Utils.cssRelativePath + Utils.cssFileName));
  		},
  		m(target, anchor) {
  		...
  		p(ctx, [dirty]) {
  			...
  			if (dirty & /*slots*/ 8192) show_if_2 = Utils.slotExiste(/*slots*/ ctx[13], 'smSearchButton');
  			...
  			if (dirty & /*slots*/ 8192) show_if_1 = Utils.slotExiste(/*slots*/ ctx[13], 'searchZone');
  			...
  			if (dirty & /*slots*/ 8192) show_if = Utils.slotExiste(/*slots*/ ctx[13], 'pivBottom');
  			...
  			if (dirty & /*containerClass*/ 32768) {
  				attr(div7, "class", /*containerClass*/ ctx[15]);
  			}

  			if (dirty & /*mounted*/ 16384) {
  				toggle_class(div8, "qc-d-none", !/*mounted*/ ctx[14]);
  			}
  		},
  		i: noop,
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	: 'Government of Québec website.', titleUrl = '/', titleText = '', titleDescription = '', altLanguageText = Utils.getPageLanguage() === 'fr'
  	? 'English'
  	...
  	$$self.$$set = $$props => {
  		...
  		if ('titleDescription' in $$props) $$invalidate(5, titleDescription = $$props.titleDescription);
