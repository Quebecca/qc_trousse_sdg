(function () {
	...
	var root$m = add_locations(from_html(`<div tabindex="0"><div class="icon-container qc-hash-161t07p"><div class="qc-icon qc-hash-161t07p"><!></div></div> <div class="content-container qc-hash-161t07p"><div class="content qc-hash-161t07p"><!> <!> <!></div></div></div>`), Notice[FILENAME], [[57, 0, [[60, 2, [[61, 4]]], [69, 2, [[70, 4]]]]]]);

	const $$css$5 = {
		hash: 'qc-hash-161t07p',
		code: '.qc-notice.qc-hash-161t07p {\n  max-inline-size: var(--qc-max-content-width);\n  display: flex;\n  border: 1px solid var(--qc-color-grey-light);\n  background-color: var(--qc-color-white);\n  word-break: break-word;\n  font-size: var(--qc-font-size-sm);\n  line-height: var(--qc-line-height-sm);\n  font-weight: var(--qc-font-weight-regular);\n}\n.qc-notice.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  display: flex;\n  padding: var(--qc-spacer-md) var(--qc-spacer-xs);\n  background-color: var(--qc-color-blue-pale);\n}\n.qc-notice.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) .qc-icon:where(.qc-hash-161t07p) {\n  background-size: 100% auto;\n  min-width: var(--qc-spacer-md);\n  height: var(--qc-spacer-md);\n}\n.qc-notice.qc-hash-161t07p .content-container:where(.qc-hash-161t07p) {\n  width: 100%;\n}\n.qc-notice.qc-hash-161t07p h1:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p h2:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p h3:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p h4:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p h5:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p h6:where(.qc-hash-161t07p), .qc-notice.qc-hash-161t07p [role=heading]:where(.qc-hash-161t07p) {\n  margin: 0;\n  padding: 0;\n  font-size: var(--qc-font-size-sm);\n  line-height: var(--qc-line-height-sm);\n  font-weight: var(--qc-font-weight-bold);\n  font-family: var(--qc-font-family-content);\n}\n.qc-notice.qc-hash-161t07p .content:where(.qc-hash-161t07p) {\n  margin: var(--qc-spacer-md) var(--qc-spacer-md) var(--qc-spacer-md) var(--qc-spacer-sm);\n}\n.qc-notice.qc-information.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  background-color: var(--qc-color-blue-pale);\n}\n/* (unused) .qc-notice.qc-information .icon-container [role=img] {\n  background-color: var(--qc-color-blue-piv);\n}*/\n.qc-notice.qc-warning.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  background-color: var(--qc-color-yellow-pale);\n}\n/* (unused) .qc-notice.qc-warning .icon-container [role=img] {\n  background-color: var(--qc-color-yellow-dark);\n}*/\n.qc-notice.qc-neutral.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  background-color: var(--qc-color-grey-pale);\n}\n/* (unused) .qc-notice.qc-neutral .icon-container [role=img] {\n  background-color: var(--qc-color-grey-dark);\n}*/\n.qc-notice.qc-error.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  background-color: var(--qc-color-red-pale);\n}\n/* (unused) .qc-notice.qc-error .icon-container [role=img] {\n  background-color: var(--qc-color-red-regular);\n}*/\n.qc-notice.qc-success.qc-hash-161t07p .icon-container:where(.qc-hash-161t07p) {\n  background-color: var(--qc-color-green-pale);\n}\n/* (unused) .qc-notice.qc-success .icon-container [role=img] {\n  background-color: var(--qc-color-green-regular);\n}*/\n\nqc-notice.qc-hash-161t07p {\n  display: block;\n}\n/* (unused) qc-notice h1, qc-notice h2, qc-notice h3, qc-notice h4, qc-notice h5, qc-notice h6, qc-notice [role=heading] {\n  margin: 0;\n  padding: 0;\n  font-size: var(--qc-font-size-sm);\n  line-height: var(--qc-line-height-sm);\n  font-weight: var(--qc-font-weight-bold);\n  font-family: var(--qc-font-family-content);\n}*/\n/* (unused) qc-notice ul {\n  padding-left: var(--qc-spacer-sm) !important;\n}*/\n/* (unused) qc-notice[type=error] ul li::marker {\n  color: var(--qc-color-text-primary);\n}*/\n/* (unused) qc-notice[type=error] ul li {\n  color: var(--qc-color-red-regular);\n}*/\n/* (unused) qc-notice[type=error] ul li a {\n  color: inherit;\n}*/\n/* (unused) qc-notice[type=error] ul li a:hover, qc-notice[type=error] ul li a:focus {\n  text-decoration: none;\n}*/\nqc-notice.qc-hash-161t07p {\n  margin-bottom: 3.2rem;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Notice($$anchor, $$props) {
			...
			var consequent = ($$anchor) => {
...

				{
					...
					element(
						...
						false,
						($$element, $$anchor) => {
							set_class($$element, 0, 'qc-hash-161t07p');
		...
		template_effect(() => {
			set_class(div, 1, `qc-component qc-notice qc-${computedType ?? ''}`, 'qc-hash-161t07p');
	...
	const $$css$4 = { hash: 'qc-hash-45h', code: '' };
	...
	var root_4$3 = add_locations(from_html(`<a class="qc-hash-wld7cr"> </a>`), PivFooter[FILENAME], [[45, 12]]);
	var root$i = add_locations(from_html(`<div class="qc-piv-footer qc-container-fluid qc-hash-wld7cr"><!> <a class="logo qc-hash-wld7cr"></a> <span class="copyright qc-hash-wld7cr"><!></span></div>`), PivFooter[FILENAME], [[20, 0, [[25, 4], [41, 4]]]]);

	const $$css$3 = {
		hash: 'qc-hash-wld7cr',
		code: '/* (unused) qc-piv-footer {\n  margin-top: 4rem;\n  padding-bottom: 4rem;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  font-size: var(--qc-font-size-sm);\n  line-height: var(--qc-line-height-sm);\n  font-weight: var(--qc-font-weight-regular);\n}*/\n/* (unused) qc-piv-footer ul {\n  max-inline-size: none;\n  margin: 0 0 var(--qc-spacer-sm) 0;\n  padding: 0;\n  width: 100%;\n  display: flex;\n  list-style-type: none;\n  justify-content: center;\n  flex-wrap: wrap;\n}*/\n/* (unused) qc-piv-footer ul li {\n  padding: 0 var(--qc-spacer-sm) var(--qc-spacer-xs);\n  margin: 0;\n  text-align: center;\n}*/\n/* (unused) qc-piv-footer a {\n  text-decoration: none;\n}*/\n/* (unused) qc-piv-footer a:hover {\n  text-decoration: underline;\n}*/\n\n.qc-piv-footer.qc-hash-wld7cr {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.qc-piv-footer.qc-hash-wld7cr a:where(.qc-hash-wld7cr) {\n  text-decoration: none;\n}\n.qc-piv-footer.qc-hash-wld7cr a:where(.qc-hash-wld7cr):hover {\n  text-decoration: underline;\n}\n.qc-piv-footer.qc-hash-wld7cr .logo:where(.qc-hash-wld7cr) {\n  display: block;\n  width: calc(var(--logo-width) * 0.1rem);\n  height: calc(var(--logo-height) * 0.1rem);\n}\n.qc-piv-footer.qc-hash-wld7cr .logo:where(.qc-hash-wld7cr) img:where(.qc-hash-wld7cr) {\n  width: 100%;\n  height: 100%;\n}\n.qc-piv-footer.qc-hash-wld7cr .copyright:where(.qc-hash-wld7cr) {\n  margin-top: 0.8rem;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
		...
		add_svelte_meta(
			() => each(a, 21, () => [['light', logoSrc()], ['dark', logoSrcDarkTheme()]], index, ($$anchor, $$item) => {
				...
				template_effect(() => {
					...
					set_attribute(img, 'alt', logoAlt());
					set_class(img, 1, `qc-${theme() ?? ''}-theme-show`, 'qc-hash-wld7cr');
				});
	...
	const $$css = { hash: 'qc-hash-45h', code: '' };
	...
	var root$7 = add_locations(from_html(`<div><!> <!> <!></div>`), Checkbox[FILENAME], [[64, 0]]);
	...
	function Checkbox($$anchor, $$props) {
		...
		add_svelte_meta(() => requiredSpanSnippet(node_1), 'render', Checkbox, 71, 4);

		var node_2 = sibling(node_1, 2);

		add_svelte_meta(() => snippet(node_2, () => children() ?? noop), 'render', Checkbox, 72, 4);
