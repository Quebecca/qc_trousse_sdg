(function () {
	...
	function create_fragment$9(ctx) {
		...
		let if_block4 = /*displaySearchForm*/ ctx[18] && create_if_block$5(ctx);
	...
	function create_fragment$6(ctx) {
		...
		let link;
		let current;
		let if_block = !/*hiddenFlag*/ ctx[4] && create_if_block$3(ctx);
	...
	class ToTop extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$6, create_fragment$5, safe_not_equal, { text: 0, demo: 1 });
		}
	...
	class ExternalLink extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$5, create_fragment$4, safe_not_equal, { externalIconAlt: 0 });
		}
	...
	class SearchBar extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$3, create_fragment$2, safe_not_equal, { value: 3, name: 4, pivBackground: 0 });
		}
	...
	/* src/sdg/components/Note/Note.svelte generated by Svelte v4.2.19 */
	...
	// (43:4) {#each $noteStore[id].links ?? [] as letter}
	function create_each_block(ctx) {
		let a;
		let t_value = /*letter*/ ctx[7] + "";
		let t;
		let a_href_value;
		...
		return {
			c() {
				a = element("a");
				t = text(t_value);
				attr(a, "href", a_href_value = "#qc-note-link-" + /*id*/ ctx[0] + "-" + /*letter*/ ctx[7]);
				toggle_class(a, "selected", /*letter*/ ctx[7] == /*$noteStore*/ ctx[3][/*id*/ ctx[0]].selected);
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, t);
			...
			p(ctx, dirty) {
				if (dirty & /*$noteStore, id*/ 9 && t_value !== (t_value = /*letter*/ ctx[7] + "")) set_data(t, t_value);

				if (dirty & /*id, $noteStore*/ 9 && a_href_value !== (a_href_value = "#qc-note-link-" + /*id*/ ctx[0] + "-" + /*letter*/ ctx[7])) {
					attr(a, "href", a_href_value);
				}

				if (dirty & /*$noteStore, id*/ 9) {
					toggle_class(a, "selected", /*letter*/ ctx[7] == /*$noteStore*/ ctx[3][/*id*/ ctx[0]].selected);
				}
			},
			d(detaching) {
	...
	function create_fragment$1(ctx) {
		...
		let each_value = ensure_array_like(/*$noteStore*/ ctx[3][/*id*/ ctx[0]].links ?? []);
		let each_blocks = [];
		...
		return {
			c() {
				...
				attr(span, "class", "note-index");
				attr(span, "id", span_id_value = "qc-note-" + /*id*/ ctx[0]);
			},
			m(target, anchor) {
				insert(target, span, anchor);
			...
			p(ctx, [dirty]) {
				if (!current || dirty & /*index*/ 2) set_data(t1, /*index*/ ctx[1]);

				if (dirty & /*id, $noteStore*/ 9) {
					each_value = ensure_array_like(/*$noteStore*/ ctx[3][/*id*/ ctx[0]].links ?? []);
					let i;
				...
				if (!current || dirty & /*id*/ 1 && span_id_value !== (span_id_value = "qc-note-" + /*id*/ ctx[0])) {
	...
	function instance$2($$self, $$props, $$invalidate) {
		let $noteStore;
		component_subscribe($$self, noteStore, $$value => $$invalidate(3, $noteStore = $$value));
		let { self, id = '', index = 0 } = $$props;
		let indexElement;
		...
		function initNoteStore(id) {
			if (id === '') return;
			set_store_value(noteStore, $noteStore[id] = { index, links: [], selected: null }, $noteStore);
		}

		function span_binding($$value) {
			binding_callbacks[$$value ? 'unshift' : 'push'](() => {
				indexElement = $$value;
				$$invalidate(2, indexElement);
			});
		}
		...
		$$self.$$.update = () => {
			...
			if ($$self.$$.dirty & /*id, index*/ 3) {
				set_store_value(noteStore, $noteStore[id].index = index, $noteStore);
			}
		};

		return [id, index, indexElement, $noteStore, self, span_binding];
	}

	class Note extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$2, create_fragment$1, safe_not_equal, { self: 4, id: 0, index: 1 });
		}
	...
	/* src/sdg/components/Note/NoteLink.svelte generated by Svelte v4.2.19 */

	function create_if_block(ctx) {
		let sup;
		let a;
		let span0;
		let t0_value = /*linkAriaLabel*/ ctx[1].replace('%note-index%', /*noteIndex*/ ctx[4]) + "";
		let t0;
		let t1;
		let span1;
		let t2;
		...
		return {
			c() {
				...
				t1 = space();
				span1 = element("span");
				t2 = text(/*noteIndex*/ ctx[4]);
				t3 = text(/*letter*/ ctx[2]);
				attr(span0, "class", "qc-sr-only");
				attr(span1, "aria-hidden", "true");
				attr(a, "href", a_href_value = "#qc-note-" + /*targetId*/ ctx[0]);
				attr(a, "id", a_id_value = "qc-note-link-" + /*targetId*/ ctx[0] + "-" + /*letter*/ ctx[2]);
			},
			m(target, anchor) {
			...
			p(ctx, dirty) {
				if (dirty & /*linkAriaLabel, noteIndex*/ 18 && t0_value !== (t0_value = /*linkAriaLabel*/ ctx[1].replace('%note-index%', /*noteIndex*/ ctx[4]) + "")) set_data(t0, t0_value);
				if (dirty & /*noteIndex*/ 16) set_data(t2, /*noteIndex*/ ctx[4]);
				if (dirty & /*letter*/ 4) set_data(t3, /*letter*/ ctx[2]);

				if (dirty & /*targetId*/ 1 && a_href_value !== (a_href_value = "#qc-note-" + /*targetId*/ ctx[0])) {
					attr(a, "href", a_href_value);
				}

				if (dirty & /*targetId, letter*/ 5 && a_id_value !== (a_id_value = "qc-note-link-" + /*targetId*/ ctx[0] + "-" + /*letter*/ ctx[2])) {
	...
	function create_fragment(ctx) {
		let if_block_anchor;
		let if_block = /*$noteStore*/ ctx[3][/*targetId*/ ctx[0]] && create_if_block(ctx);
		...
		return {
			...
			p(ctx, [dirty]) {
				if (/*$noteStore*/ ctx[3][/*targetId*/ ctx[0]]) {
					if (if_block) {
						if_block.p(ctx, dirty);
					} else {
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		let { targetId, linkAriaLabel = lang === 'fr'
		? "Aller à la note %note-index%"
		: "Go to note %note-index%" } = $$props;

		let letter, noteIndex;
		...
		const click_handler = _ => set_store_value(noteStore, $noteStore[targetId].selected = letter, $noteStore);

		$$self.$$set = $$props => {
			if ('targetId' in $$props) $$invalidate(0, targetId = $$props.targetId);
			if ('linkAriaLabel' in $$props) $$invalidate(1, linkAriaLabel = $$props.linkAriaLabel);
		};

		$$self.$$.update = () => {
			if ($$self.$$.dirty & /*letter, $noteStore, targetId*/ 13) {
				if (!letter && $noteStore[targetId]) {
					$$invalidate(2, letter = indexToLetter($noteStore[targetId].links.length + 1));
					set_store_value(noteStore, $noteStore[targetId].links = [...$noteStore[targetId].links, letter], $noteStore);
				}
			}

			if ($$self.$$.dirty & /*$noteStore, targetId*/ 9) {
				$$invalidate(4, noteIndex = $noteStore[targetId].index);
			}
		};

		return [targetId, linkAriaLabel, letter, $noteStore, noteIndex, click_handler];
	}

	class NoteLink extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$1, create_fragment, safe_not_equal, { targetId: 0, linkAriaLabel: 1 });
		}
		...
		set linkAriaLabel(linkAriaLabel) {
			this.$$set({ linkAriaLabel });
			flush();
		}
	}

	customElements.define("qc-note-link", create_custom_element(NoteLink, {"targetId":{"attribute":"target-id","type":"String"},"linkAriaLabel":{}}, [], [], false));

	/* src/sdg/components/Note/NoteContainer.svelte generated by Svelte v4.2.19 */
	...
	class NoteContainer extends SvelteComponent {
		constructor(options) {
			super();
