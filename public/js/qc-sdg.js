(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-1hu8pih"><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-1hu8pih" href="#top"><!></a></div>`), Tooltip[FILENAME], [[345, 4, [[354, 8], [357, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-1hu8pih" role="button" tabindex="-1"><!></span>`), Tooltip[FILENAME], [[276, 5]]);

	var root_4 = add_locations(
		from_html(
			`<div><svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="qc-hash-1hu8pih"><style class="qc-hash-1hu8pih">.triangle {
                        fill: var(--qc-color-background);
                    }
                    .stroke {
                        fill: var(--qc-color-grey-light);
                    }</style><path class="triangle qc-hash-1hu8pih" d="M8.02002 14.1667L1.35335 7.50004L8.02002 0.833374L8.02002 14.1667Z"></path><path class="stroke qc-hash-1hu8pih" d="M1.35335 7.5L8.02002 14.1667L8.02002 15H7.02002V14.5118L1.90735e-05 7.5L7.02002 0.488157V0L8.02002 3.64262e-08L8.02002 0.833335L1.35335 7.5Z"></path></svg></div> <!>`,
			1
		),
		Tooltip[FILENAME],
		[[304, 9, [[307, 13, [[313, 16], [321, 16], [324, 16]]]]]]
	);

	var root_3 = add_locations(from_html(`<div><a role="button" class="qc-tooltip-button qc-hash-1hu8pih" href="#top"><!></a> <!> <dialog><div class="qc-container qc-hash-1hu8pih"><!></div></dialog></div>`), Tooltip[FILENAME], [[283, 5, [[288, 9], [331, 9, [[335, 12]]]]]]);
	var root$1 = add_locations(from_html(`<span class="qc-tooltip qc-hash-1hu8pih"><!> <!></span>`), Tooltip[FILENAME], [[263, 0]]);

	const $$css = {
		hash: 'qc-hash-1hu8pih',
		code: '\n    .qc-tooltip.qc-hash-1hu8pih {\n        display: inline-flex;\n        align-items: center;\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .qc-tooltip-text.qc-hash-1hu8pih {\n        border-bottom: 1px dashed var(--qc-color-text-primary);\n        cursor: pointer;\n    }\n    .qc-tooltip-button.qc-hash-1hu8pih {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        margin-left: 4px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-1hu8pih {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-1hu8pih {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-1hu8pih {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-1hu8pih {\n        overflow-y: auto;\n        max-height:calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right:16px;\n        padding-top: 2px;\n    }\n\n    .qc-tooltip-content.qc-hash-1hu8pih:focus-visible {\n        outline: none;\n    }\n\n    .qc-tooltip-xclose.qc-hash-1hu8pih {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n    dialog.qc-hash-1hu8pih {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n\n        &.qc-desktop {\n            padding-top: 8px;\n        }\n\n        .qc-tooltip-panel:where(.qc-hash-1hu8pih) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-1hu8pih) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-1hu8pih {\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        max-width: var(--qc-max-content-width);\n        padding-top: 22px;\n        padding-bottom: 24px;\n    }\n\n    .qc-tooltip-popover.qc-hash-1hu8pih {\n\n        .qc-tooltip-panel:where(.qc-hash-1hu8pih) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding-right: 8px;\n            padding-left: 16px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-1hu8pih) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-1hu8pih) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            left: calc(var(--pin-height) - 1px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-1hu8pih) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            left: 8px;\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-1hu8pih) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-1hu8pih) {\n            visibility: visible;\n        }\n\n        .qc-tooltip-content:where(.qc-hash-1hu8pih):focus-visible {\n            outline: 2px solid var(--qc-color-blue-regular);\n            outline-offset: 1px;\n        }\n    }\n\n    .qc-hash-1hu8pih::-webkit-scrollbar,\n    .qc-hash-1hu8pih::-webkit-scrollbar-track,\n    .qc-hash-1hu8pih::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-1hu8pih::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => Icon(node_1, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 367, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
			bind_this(div, ($$value) => set(tooltipPanel, $$value), () => get(tooltipPanel));

			template_effect(() => {
				classes = set_class(div, 1, 'qc-tooltip-panel qc-hash-1hu8pih', null, classes, {
...

		{
			var consequent_2 = ($$anchor) => {
				...
				add_svelte_meta(() => Icon(node_5, { type: 'info-tooltip', size: 'sm' }), 'component', Tooltip, 301, 12, { componentTag: 'Icon' });
				reset(a_1);
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_7, () => "popover"), 'render', Tooltip, 329, 9);
						template_effect(() => classes_2 = set_class(div_3, 1, 'qc-tooltip-pin qc-hash-1hu8pih', null, classes_2, { 'qc-tooltip-visible': get(visiblePopover) }));
						append($$anchor, fragment);
					};
				...
				add_svelte_meta(() => tooltipPanelSnippet(node_8, () => "modal"), 'render', Tooltip, 336, 16);
				reset(div_4);
				reset(dialog);
				...
				template_effect(() => {
					classes_1 = set_class(div_2, 1, `qc-tooltip-container qc-tooltip-${get(position) ?? ''} qc-scrollbar`, 'qc-hash-1hu8pih', classes_1, {
					...
					classes_3 = set_class(dialog, 1, 'qc-hash-1hu8pih', null, classes_3, { 'qc-desktop': !get(mobileFlag) });
				});
