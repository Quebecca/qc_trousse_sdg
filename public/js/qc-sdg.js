	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				span = element("span");
				attr(span, "role", "img");
				attr(span, "class", "qc-ext-link-img qc-hash-hlv4ad");
