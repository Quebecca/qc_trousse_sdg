(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-14l1zul"><div class="qc-tooltip-content-text qc-hash-14l1zul"><!><!></div></div> <a role="button" class="qc-tooltip-xclose qc-hash-14l1zul" href="#top"><!></a></div>`), Tooltip[FILENAME], [[418, 4, [[428, 8, [[429, 12]]], [433, 8]]]]);
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 430, 31);
			reset(div_2);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 448, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 396, 9);
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_11, () => "modal"), 'render', Tooltip, 408, 16);
						reset(div_7);
						reset(dialog);
