(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-1qgyj6k"><!><!></div> <a role="button" class="qc-tooltip-xclose qc-hash-1qgyj6k" href="#top"><!></a></div>`), Tooltip[FILENAME], [[391, 4, [[400, 8], [403, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-1qgyj6k" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[316, 5]]);
	var root_3 = add_locations(from_html(`<span class="qc-hash-1qgyj6k">&zwj;</span>`), Tooltip[FILENAME], [[321, 8]]);
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 401, 31);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 414, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
...

		{
			var consequent = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_5, textSlot), 'render', Tooltip, 319, 21);
				reset(span);
				append($$anchor, span);
			};
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 373, 9);
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_11, () => "modal"), 'render', Tooltip, 381, 16);
						reset(div_5);
						reset(dialog);
