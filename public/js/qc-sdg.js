(function () {
	...
	var root$u = add_locations(from_html(`<div tabindex="0"><div class="icon-container"><div class="qc-icon"><!></div></div> <div class="content-container"><div class="content"><!> <!> <!></div></div></div>`), Notice[FILENAME], [[61, 0, [[64, 2, [[65, 4]]], [73, 2, [[74, 4]]]]]]);
	...
	function Notice($$anchor, $$props) {
		...
		add_svelte_meta(() => snippet(node_6, () => slotContent() ?? noop), 'render', Notice, 83, 8);
		reset(div_4);
	...
	function Tooltip($$anchor, $$props) {
		...
		tooltipPanelSnippet = wrap_snippet(Tooltip, function ($$anchor, displayMode = noop) {
			...
			add_svelte_meta(() => Icon(node_4, { type: 'xclose', color: 'blue-piv', size: 'nm', vAlign: 'top' }), 'component', Tooltip, 452, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
