(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-14l1zul"><div class="qc-tooltip-content-text qc-hash-14l1zul"><!><!></div></div> <a role="button" class="qc-tooltip-xclose qc-hash-14l1zul" href="#top"><!></a></div>`), Tooltip[FILENAME], [[419, 4, [[429, 8, [[430, 12]]], [434, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-14l1zul" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[331, 5]]);
	var root_3 = add_locations(from_html(`<span class="qc-hash-14l1zul">&zwj;</span>`), Tooltip[FILENAME], [[336, 8]]);

	var root_5 = add_locations(
		from_html(
			`<div aria-hidden="true"><svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="qc-hash-14l1zul"><style class="qc-hash-14l1zul">.triangle {
                        fill: var(--qc-color-background);
                    }
                    .stroke {
                        fill: var(--qc-color-grey-light);
                    }</style><path class="triangle qc-hash-14l1zul" d="M8.02002 14.1667L1.35335 7.50004L8.02002 0.833374L8.02002 14.1667Z"></path><path class="stroke qc-hash-14l1zul" d="M1.35335 7.5L8.02002 14.1667L8.02002 15H7.02002V14.5118L1.90735e-05 7.5L7.02002 0.488157V0L8.02002 3.64262e-08L8.02002 0.833335L1.35335 7.5Z"></path></svg></div> <!>`,
			1
		),
		Tooltip[FILENAME],
		[[371, 9, [[375, 13, [[381, 16], [389, 16], [392, 16]]]]]]
	);

	var root_6 = add_locations(from_html(`<dialog><div class="qc-container qc-hash-14l1zul"><!></div></dialog>`), Tooltip[FILENAME], [[400, 9, [[408, 12]]]]);
	var root_4 = add_locations(from_html(`<div><div class="clickable-gutter qc-hash-14l1zul"></div> <a role="button" class="qc-tooltip-button qc-hash-14l1zul" href="#top"><!></a> <!> <!></div>`), Tooltip[FILENAME], [[340, 5, [[347, 9], [354, 9]]]]);
	var root$1 = add_locations(from_html(`<div class="qc-tooltip qc-hash-14l1zul"><!> <!></div>`), Tooltip[FILENAME], [[317, 0]]);

	const $$css = {
		hash: 'qc-hash-14l1zul',
		code: '\n    .qc-tooltip.qc-hash-14l1zul {\n        display: inline-flex;\n        align-items: center;\n        font-size: var(--qc-font-size-md);\n        font-family: var(--qc-font-family-content);\n        font-weight: var(--qc-font-weight-regular);\n        --pin-gap: 4px;\n        --pin-height: 9px;\n        --pin-base: 15px;\n    }\n    .clickable-gutter.qc-hash-14l1zul {\n        position: absolute;\n        height: 24px;\n        width: 24px;\n        left: -4px;\n        top: -4px;\n        cursor: pointer;\n    }\n    .qc-tooltip-text.qc-hash-14l1zul {\n        border-bottom: 1px dashed var(--qc-color-blue-piv);\n        cursor: pointer;\n        white-space: nowrap;\n        margin-right: calc( .5 * var(--qc-spacer-xs) );\n    }\n    .qc-tooltip-button.qc-hash-14l1zul {\n        align-self: center;\n        height: 16px;\n        width: 16px;\n        line-height: 16px;\n        display: block;\n        position: relative;\n    }\n    .qc-tooltip-container.qc-hash-14l1zul {\n        position: relative;\n    }\n    .qc-tooltip-pin.qc-hash-14l1zul {\n        position: absolute;\n        top:0;\n        left: calc(100% + var(--pin-gap) + 1px);\n        z-index: 200;\n        width: var(--pin-height);\n        height: var(--pin-base);\n    }\n\n    svg.qc-hash-14l1zul {\n        display: block;\n    }\n\n    .qc-tooltip-content.qc-hash-14l1zul {\n        overflow-y: auto;\n        max-height: calc(var(--max-height) - 48px);\n        scrollbar-gutter: stable;\n        padding-right: 16px;\n        padding-top: 3px;\n        padding-left: 3px;\n    }\n\n    .qc-tooltip-content-text.qc-hash-14l1zul {\n        max-inline-size: var(--qc-max-content-width);\n    }\n\n    .qc-tooltip-content.qc-hash-14l1zul:focus-visible {\n        outline: none;\n    }\n\n    .qc-tooltip-xclose.qc-hash-14l1zul {\n        position: absolute;\n        right: 8px;\n        top: 8px;\n        line-height: 16px;\n        height: 16px;\n    }\n\n    dialog.qc-hash-14l1zul {\n        top: auto;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        max-width: 100%;\n        width: 100%;\n        height: auto;\n        margin: 0;\n        padding: 0;\n        border: 1px solid var(--qc-color-grey-light);\n        background: var(--qc-color-background);\n\n        &.qc-desktop {\n            padding-top: 8px;\n        }\n\n        .qc-tooltip-panel:where(.qc-hash-14l1zul) {\n            visibility: visible!important;\n        }\n\n        &::backdrop {\n            background-color: rgba(var(--qc-color-blue-dark-rgb), .25)\n        }\n\n        .qc-tooltip-xclose:where(.qc-hash-14l1zul) {\n            right: 0;\n        }\n    }\n\n    .qc-tooltip-panel.qc-hash-14l1zul {\n        font-size: var(--qc-font-size-sm);\n        line-height: var(--qc-line-height-sm);\n        position: relative;\n        min-height: 68px;\n        max-height: var(--max-height);\n        background: var(--qc-color-background);\n        color: var(--qc-color-text-primary);\n        width: 100%;\n        padding-top: 21px;\n        padding-left: 13px;\n        padding-bottom: 24px;\n    }\n\n    .qc-tooltip-popover.qc-hash-14l1zul {\n\n        .qc-tooltip-panel:where(.qc-hash-14l1zul) {\n            visibility: hidden;\n            position: absolute;\n            min-width: 216px;\n            max-width: 320px;\n            padding-right: 8px;\n            width: max-content;\n            border: 1px solid var(--qc-color-grey-light);\n            transform: translateY(var(--translateY));\n            top:0;\n            left: calc(100% + var(--pin-gap) + var(--pin-height) - 1px);\n            z-index:199;\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-panel:where(.qc-hash-14l1zul) {\n            top: calc(100% + var(--pin-height) + var(--pin-gap));\n            left:auto;\n            transform: translateX(var(--translateX));\n        }\n\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-14l1zul),\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-14l1zul)\n        {\n            left: calc(.5 * var(--pin-height) - 1px);\n        }\n        &.qc-tooltip-top .qc-tooltip-pin:where(.qc-hash-14l1zul) {\n            top: calc(-100% - var(--pin-gap) + 2px);\n            transform: rotate(-90deg);\n        }\n\n        &.qc-tooltip-bottom .qc-tooltip-pin:where(.qc-hash-14l1zul) {\n            top: calc(100% + var(--pin-gap) - 1px);\n            transform: rotate(90deg);\n        }\n\n        &.qc-tooltip-top .qc-tooltip-panel:where(.qc-hash-14l1zul) {\n            /*display: none;*/\n            top: 0;\n            transform: translate(\n                    var(--translateX),\n                    calc(-100% - var(--pin-gap) - var(--pin-height))\n            );\n            left:auto;\n        }\n        .qc-tooltip-visible:where(.qc-hash-14l1zul) {\n            visibility: visible;\n        }\n\n        .qc-tooltip-content:where(.qc-hash-14l1zul):focus-visible {\n            outline: 2px solid var(--qc-color-blue-regular);\n            outline-offset: 1px;\n        }\n    }\n\n    .qc-hash-14l1zul::-webkit-scrollbar,\n    .qc-hash-14l1zul::-webkit-scrollbar-track,\n    .qc-hash-14l1zul::-webkit-scrollbar-thumb\n    {\n        height: 50%;\n        margin-top: 10px;\n        margin-right: -8px;\n    }\n    .qc-hash-14l1zul::-webkit-scrollbar-thumb {\n        background: var(--qc-color-blue-piv);\n    }\n\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
	};
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			add_svelte_meta(() => snippet(node_1, descriptionSlot), 'render', Tooltip, 431, 31);
			reset(div_2);
			reset(div_1);
			...
			add_svelte_meta(() => Icon(node_2, { type: 'xclose', color: 'blue-piv', size: 'sm' }), 'component', Tooltip, 449, 12, { componentTag: 'Icon' });
			reset(a);
			reset(div);
			bind_this(div, ($$value) => set(tooltipPanel, $$value), () => get(tooltipPanel));

			template_effect(() => {
				classes = set_class(div, 1, 'qc-tooltip-panel qc-hash-14l1zul', null, classes, {
...

		{
			var consequent = ($$anchor) => {
				...
				add_svelte_meta(() => snippet(node_5, textSlot), 'render', Tooltip, 334, 21);
				reset(span);
				append($$anchor, span);
			};
			...
			add_svelte_meta(
				() => if_block(node_3, ($$render) => {
					if (get(hasText)) $$render(consequent); else $$render(alternate, false);
				}),
				'if',
				Tooltip,
				330,
...

		{
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_9, () => "popover"), 'render', Tooltip, 397, 9);
						template_effect(() => classes_2 = set_class(div_6, 1, 'qc-tooltip-pin qc-hash-14l1zul', null, classes_2, { 'qc-tooltip-visible': get(visiblePopover) }));
						append($$anchor, fragment);
					};

					add_svelte_meta(
						() => if_block(node_8, ($$render) => {
							if (!get(modalFlag) && get(displayPopover)) $$render(consequent_1);
						}),
						'if',
						Tooltip,
						370,
...

				{
					var consequent_2 = ($$anchor) => {
						...
						add_svelte_meta(() => tooltipPanelSnippet(node_11, () => "modal"), 'render', Tooltip, 409, 16);
						reset(div_7);
						reset(dialog);
						bind_this(dialog, ($$value) => set(modale, $$value), () => get(modale));
						template_effect(() => classes_3 = set_class(dialog, 1, 'qc-hash-14l1zul', null, classes_3, { 'qc-desktop': !get(mobileFlag) }));
					...
					add_svelte_meta(
						() => if_block(node_10, ($$render) => {
							if (get(modalFlag) && get(displayModal)) $$render(consequent_2);
						}),
						'if',
						Tooltip,
						399,
				...
				template_effect(() => {
					classes_1 = set_class(div_4, 1, `qc-tooltip-container qc-tooltip-${get(position) ?? ''} qc-scrollbar`, 'qc-hash-14l1zul', classes_1, {
			...
			add_svelte_meta(
				() => if_block(node_6, ($$render) => {
					if (get(hasDescription)) $$render(consequent_3);
				}),
				'if',
				Tooltip,
				338,
	...
	var root = add_locations(from_html(`<!> <link rel="stylesheet"/>`, 1), TooltipWC[FILENAME], [[28, 0]]);
