(function () {
	...
	var root_1$4 = add_locations(template(`<span class="qc-required" aria-hidden="true">*</span>`), Label[FILENAME], [[25, 30]]);
	var root$8 = add_locations(template(`<label><!><!></label>`), Label[FILENAME], [[14, 0]]);
