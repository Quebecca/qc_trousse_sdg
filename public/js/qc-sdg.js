(function () {
	...
	var root_1 = add_locations(from_html(`<div role="tooltip"><div class="qc-tooltip-content qc-hash-12013e3"><div class="qc-tooltip-content-text qc-hash-12013e3"><!><!></div></div> <a role="button" class="qc-tooltip-xclose qc-hash-12013e3" href="#top"><!></a></div>`), Tooltip[FILENAME], [[408, 4, [[418, 8, [[419, 12]]], [423, 8]]]]);
	var root_2 = add_locations(from_html(`<span class="qc-tooltip-text qc-hash-12013e3" tabindex="-1"><!><!></span>`), Tooltip[FILENAME], [[329, 5]]);
	var root_3 = add_locations(from_html(`<span class="qc-hash-12013e3">&zwj;</span>`), Tooltip[FILENAME], [[334, 8]]);

	var root_5 = add_locations(
		from_html(
			`<div aria-hidden="true"><svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="qc-hash-12013e3"><style class="qc-hash-12013e3">.triangle {
                        fill: var(--qc-color-background);
                    }
                    .stroke {
                        fill: var(--qc-color-grey-light);
                    }</style><path class="triangle qc-hash-12013e3" d="M8.02002 14.1667L1.35335 7.50004L8.02002 0.833374L8.02002 14.1667Z"></path><path class="stroke qc-hash-12013e3" d="M1.35335 7.5L8.02002 14.1667L8.02002 15H7.02002V14.5118L1.90735e-05 7.5L7.02002 0.488157V0L8.02002 3.64262e-08L8.02002 0.833335L1.35335 7.5Z"></path></svg></div> <!>`,
			1
		),
		Tooltip[FILENAME],
	...
	function Tooltip($$anchor, $$props) {
		...
		const tooltipPanelSnippet = wrap_snippet(Tooltip, function (
			...
			template_effect(() => {
				classes = set_class(div, 1, 'qc-tooltip-panel qc-hash-12013e3', null, classes, {
			...
			var consequent_3 = ($$anchor) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						template_effect(() => classes_2 = set_class(div_5, 1, 'qc-tooltip-pin qc-hash-12013e3', null, classes_2, { 'qc-tooltip-visible': get(visiblePopover) }));
						append($$anchor, fragment);
					};
...

				{
					var consequent_2 = ($$anchor) => {
						...
						template_effect(() => classes_3 = set_class(dialog, 1, 'qc-hash-12013e3', null, classes_3, { 'qc-desktop': !get(mobileFlag) }));
				...
				template_effect(() => {
					classes_1 = set_class(div_4, 1, `qc-tooltip-container qc-tooltip-${get(position) ?? ''} qc-scrollbar`, 'qc-hash-12013e3', classes_1, {
