(function () {
	...
	function add_css$1(target) {
		append_styles(target, "qc-hash-1k39xbb", "@charset \"UTF-8\";:root{font-size:var(--qc-font-size-root-percent)}a.qc-hash-1k39xbb{color:var(--qc-color-link-text)}a.qc-hash-1k39xbb:visited{color:var(--qc-color-link-visited)}a.qc-hash-1k39xbb:hover,a.qc-hash-1k39xbb:focus{color:var(--qc-color-link-hover);text-decoration:none}a.qc-hash-1k39xbb:active{color:var(--qc-color-link-active);text-decoration:none}:host{display:flex;flex-direction:column;align-items:center;margin-top:4rem;padding-bottom:3.2rem;font-size:var(--qc-font-size-sm);line-height:var(--qc-line-height-sm);font-weight:var(--qc-font-weight-regular)}a.qc-hash-1k39xbb{text-decoration:none}a.qc-hash-1k39xbb:hover{text-decoration:underline}.copyright.qc-hash-1k39xbb{margin-top:3.2rem}@media(prefers-color-scheme: dark){svg.qc-hash-1k39xbb{fill:var(--qc-color-text-primary)}}");
	}
	...
	function fallback_block_1(ctx) {
		...
		return {
			c() {
				...
				attr(svg, "class", "qc-hash-1k39xbb");
				attr(a, "href", /*logoUrl*/ ctx[0]);
				attr(a, "class", "qc-hash-1k39xbb");
			},
			m(target, anchor) {
				insert(target, a, anchor);
				append(a, svg);
	...
	function create_fragment$3(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "logo");
				attr(span, "class", "copyright qc-hash-1k39xbb");
			},
			m(target, anchor) {
				if (default_slot) {
